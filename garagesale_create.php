...
if($_SESSION['Nris_session']['id'] > 0 && $_GET['verified'] == '') {
	...
	$query_count = "select count(id) as cnt from post_free_garage_sale
...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState ?> - Garage Sale Create Ad | NRIs</title>
...
if(isset($_POST['Submit']))
{
	...
	/*	$items1 = test_input($_POST["items1"]);				
		$items2 = test_input($_POST["items2"]);
		$items3 = test_input($_POST["items3"]);				
		$items4 = test_input($_POST["items4"]);
		$items5 = test_input($_POST["items5"]);				
		$items6 = test_input($_POST["items6"]);
		$items7 = test_input($_POST["items7"]);	*/
		
						
		$querycat="select * from  garagesale order by name";
		$resultcat=mysql_query($querycat);    
		 mysql_num_rows($resultcat);
		for($j=1; $j<=mysql_num_rows($resultcat); $j++)
		{
			$checkeditems  =	"items".$j;
//			echo $checkeditems ;
			$items .= $_POST[$checkeditems]."#";
		}	
/*		echo $items."<bR>";
		$a = explode("#",$items);
		echo $a[0];
		...
		*/
		...
		if($fileSize1<=200){			
				...
				if($_FILES['my_file1']['name'] != '') {
					...
					$img1="uploads/garage_sale/".$image1;
		...
		if($adPosttype!='')	
		{
					if($_FILES["my_file2"]["name"] != '') {
						...
						if($fileSize2<=200){			
								...
								$img2="uploads/garage_sale/".$image2;
						...
						if($fileSize3<=200){			
								...
								$img3="uploads/garage_sale/".$image3;
					...
					$img4="uploads/garage_sale/".$image4;
					...
					$img5="uploads/garage_sale/".$image5;
					...
					$img6="uploads/garage_sale/".$image6;
					...
					$img7="uploads/garage_sale/".$image7;
					...
					$img8="uploads/garage_sale/".$image8;
					...
					$img9="uploads/garage_sale/".$image9;
					...
					$img10="uploads/garage_sale/".$image10;
					...
					$img11="uploads/garage_sale/".$image11;
					...
					$img12="uploads/garage_sale/".$image12;
					...
					$img13="uploads/garage_sale/".$image13;
					...
					$img14="uploads/garage_sale/".$image14;
					...
					$img15="uploads/garage_sale/".$image15;
	...
	//	echo $Error;
		...
		if($adPosttype!='')	
		{
			$query=mysql_query("insert into post_free_garage_sale (TitleAD,Message,items1,ConatctNAME,ConatctNumber,ConatctEmail,Contact_PID,ShowEmail,City,image,image2,image3,image4,image5,image6,image7,image8,image9,image10,image11,image12,image13,image14,image15,AdPostType,EndDate,date,time,States) VALUES('".$TitleAD."','".$Desrp."','".$items."','".$ConatctNAME."','".$ConatctNumber."','".$ConatctEmail."','".$pid."','".$ShowEmail."','".$City."','".$image1."','".$image2."','".$image3."','".$image4."','".$image5."','".$image6."','".$image7."','".$image8."','".$image9."','".$image10."','".$image11."','".$image12."','".$image13."','".$image14."','".$image15."','".$adPosttype."','".$EndDate."','".$date."','".$time."','".$state."')");
		}
		else
		{
		...
		if($_GET['type'] == 'premium') {
				...
				$type = 'garagesale_create';
				$table_name = 'post_free_garage_sale';
				?>
...
<div class="widget-temple">
	<?php $state = $defaultState;?>
				<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $state;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant.'garagesale_inner?code='.$state;?>" class="breadcumb_link">Garage Sale</a> >> Create Ad</h4>
</div><br>
...
<div class="col-md-12">
<div class="form-group">
	<label for="inputEmail3" class="col-sm-12 control-label"  style="text-align:left;">Items in garage sale*</label>
	...
	<div class="col-sm-3"> <input name="items<?php echo $cnt;?>" value="<?php echo $rs_cat['name'];?>" type="checkbox" tabindex="4"  onClick="add_sub(this);">&nbsp;<?php echo $rs_cat['name'];?></div>         
	<?php $cnt++;   } ?>

<!--	<div class="col-sm-3"> <input name="items1" value="TV" type="checkbox" tabindex="4"  onClick="add_sub(this);">&nbsp;TV</div>         
  	<div class="col-sm-3"> <input name="items2" value="Blueray/DVD Players" type="checkbox"  onClick="add_sub(this);" tabindex="5">&nbsp;Blueray/DVD Players</div>         
	<div class="col-sm-3"> <input name="items3" value="Blueray/DVD Casetts" type="checkbox" onClick="add_sub(this);" tabindex="6">&nbsp;Blueray/DVD Casetts</div>             
	<div class="col-sm-3"> <input name="items4" value="Fridge" type="checkbox"  onClick="add_sub(this);" tabindex="7">&nbsp;Fridge</div>                 
	<div class="col-sm-3"> <input name="items4" value="Lights" type="checkbox"  onClick="add_sub(this);" tabindex="8">&nbsp;Lights</div>                     
	<div class="col-sm-3"> <input name="items5" value="Desktop" type="checkbox"  onClick="add_sub(this);" tabindex="9">&nbsp;Desktop</div>                         
	<div class="col-sm-3"> <input name="items6" value="Grinder/Mixie" type="checkbox"  onClick="add_sub(this);" tabindex="10">&nbsp;Grinder/Mixie</div>                             -->
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="text" class="form-control" id="ConatctNAME" name="ConatctNAME" placeholder="Contact Name" style="width:100%;margin-bottom:0px;" tabindex="11" value="<?php echo $_SESSION['Nris_session']['fname'] ?> <?php echo $_SESSION['Nris_session']['lname'] ?>" />               		
	</div>
</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="text" class="form-control" id="ConatctNumber" name="ConatctNumber" placeholder="Contact Number" style="width:100%;margin-bottom:0px;" tabindex="12" value="<?php echo $_SESSION['Nris_session']['mobile'] ?> " />               		
	</div>
</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="text" class="form-control" id="ConatctEmail" name="ConatctEmail" readonly placeholder="Contact Email" style="width:100%;margin-bottom:0px;" tabindex="13" value="<?php echo $_SESSION['Nris_session']['email'] ?> " />               		
	</div>
</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="checkbox" id="ShowEmail" name="ShowEmail" tabindex="14"  value="Yes" />&nbsp;
...
<div class="form-group">
	...
	<div class="col-sm-8">
		<input type="file" class="form-control" id="my_file1" name="my_file1" placeholder="" tabindex="16" />
	</div>
</div>
</div>
...
<div class="col-md-12">
<div class="form-group">
	<label for="inputEmail3" class="col-sm-2 control-label"  style="text-align:left;">Ad Expiry Date</label>
	<div class="col-sm-8">
        <input type="text" class="form-control" name="EndDate" id="EndDate" tabindex="17" required>
	</div>
</div>
</div>
...
<br style="clear:both;"><br><br><br><br><br><br>			
	...
	<?php
		...
		if($final_count >= 3) {
			$url = 'adcheck?redirect=garagesale_create&State='.$state;
