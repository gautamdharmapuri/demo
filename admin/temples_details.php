...
if(isset($_POST['submit']))
	{ 
			if($_POST['action']=='edit')
			{
				...
				$img="uploads/temples/".$image;
				move_uploaded_file($_FILES['txtimage']['tmp_name'],$img);		
				$img=$_FILES['txtimage']['name'];	
				if($img != ''){unlink('uploads/temples/'.$_POST['imgId']);}
				if($img == ''){$img=$_POST['imgId'];}
				}else
				$image=$_POST['imgId'];				
									
						
				$query="update fam_temples set state_code='".$a."',city_id='".$b."',temple_name='".$c."',temple_type='".$d."',contact='".$ph."',address='".$add."',url='".$url."',email_id='".$email_ID."',status='".$status."',image='".$image."',other_details='".$others."',date='".$date."',time='".$time."' where id='".$_POST['id']."'";
				$result=mysql_query($query);
				 echo "<script language='javascript' type='text/javascript'>alert('Temple Details Updated sucsessfully');</script>";		 
				 echo"<script language='javascript' type='text/javascript'>document.location='temples.php';</script>";
				exit;			
		 ...
		 $query="insert into  fam_temples(state_code,city_id,temple_name,temple_type,contact,address,url,email_id,status,image,other_details,date,time) values('".$a."','".$b."','".$c."','".$d."','".$ph."','".$add."','".$url."','".$email_ID."','".$status."','".$image."','".$others."','".$date."','".$time."')";		 
		 $result=mysql_query($query);
		 echo "<script language='javascript' type='text/javascript'>alert('Temple added sucsessfully');</script>";		 
		 echo"<script language='javascript' type='text/javascript'>document.location='temples.php';</script>";
		 exit;	 
...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?> Famous Temple | NRIs</title>            
...
<script language="javascript" type="text/javascript">
	function frmchk()
	{
		...
		{
			alert('Please Enter Temple Type');			
		...
		data  = document.getElementById('txtdesc').value;
				 if (data.length < 1)	
				{
						alert('Please Enter Temple Address');					
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="dashboard.php">Home</a></li>     
                      <li><a href="temples.php">State Famous Places</a></li>                     
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?>Temple Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            <?php 			
                                ...
                                //    $query="select * from fam_temples where state_code='".$_GET['editId']."'";
								 $query="select a.*, b.state from fam_temples a, states b where a.state_code = b.state_code and a.id = '".$_GET['editId']."'";
							//	 echo $query;
                                    $result=mysql_query($query);
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?></strong> Temple</h3>
                                 </div>
                                ...
                                <div class="panel-body">                                                                        
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Temple Name</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="txtemplenm" id="txtemplenm" class="form-control" value="<?php echo $rs['temple_name']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Temple Name</span>                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Temple Type</label>
                                                <div class="col-md-6 col-xs-12"> 
                                                <select class="form-control select" data-style="btn-success" name="txtttype" id="txtttype">                                                     	<?php
													   	if(isset($rs['temple_type']))
														{?>
                                                        <option value="<?php echo $rs['temple_type']; ?>" selected ><?php echo $rs['temple_type']; ?></option
                                                         ><?php }  ?>
                                                         <option value="">- Select Temple Type -</option>
                                                        <option value="Hindu Temples">Hindu Temples</option>
                                                        <option value="ISKON Temple" >ISKON Temple</option>
                                                        <option value="Jain Temples" >Jain Temples</option>
                                                        <option value="Gurudwara" >Gurudwara</option>
                                                        <option value="Churches">Churches</option>
                                                        <option value="Mosques & Darga">Mosques & Darga</option>
                                                        <option value="Budda Vihar" >Budda Vihar</option>
                                                        <option value="Other">Other</option>
                                                        </select>
                                                <span class="help-block">Select Temple Type</span>
                                                </div>
                                            </div>
                                            
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Temple Conatct No</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> Temple Address</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="txtdesc" id="txtdesc" rows="5"><?php echo $rs['address']; ?></textarea>
                                            <span class="help-block">Temple Address</span>                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Temple URL (If any)</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-globe"></span></span>
                                                <input type="text" name="txturl" id="txturl" class="form-control" value="<?php echo $rs['url']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Temple URL</span>                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Status</label>
                                                ...
                                                <span class="help-block">Select Temple Status</span>
                                                </div>
                                            </div>
                                    
                                    <?php /*?><div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Temple Image</label>
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <span class="help-block">Upload Temple image</span>                                        </div>
                                   ...
                                   <input type="file" class="fileinput btn-primary" name="txtimage" id="txtimage" title="Browse file"/>
                                             <?php   if (strpos($rs['image'],'.') !== false) {  ?>
                                <img src="uploads/temples/<?php echo $rs['image'];?>" height="60" width="auto" style="padding:5px 5px 5px 5px;">	<?php }   ?>
                                            <span class="help-block">Temple Image</span>                                        </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" type="submit" name="submit" id="submit"><?php if(isset($_GET['editId'])) { echo "Update "; } else { echo "Add "; } ?> Temple Details</button>
                                </div>
                            </div>
                            </form>
                        </div>
