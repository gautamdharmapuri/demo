...
if(isset($_POST['submit']))
	{  
			...
			{	
				...
				$img="uploads/events/".$image;
				move_uploaded_file($_FILES['txtimage']['tmp_name'],$img);		
				$img=$_FILES['txtimage']['name'];	
				if($img != ''){unlink('uploads/events/'.$_POST['imgId']);}
				if($img == ''){$img=$_POST['imgId'];}
				}else
				$image=$_POST['imgId'];				
									
						
				$query="update events set state_code='".$a."',city_id='".$b."',title='".$c."',category='".$d."',details='".$details."',address='".$add."',url='".$url."',email_id='".$email_ID."',sdate='".$sd."',edate='".$ed."',status='".$status."',image='".$image."',other_details='".$others."',date='".$date."',time='".$time."' where id='".$_POST['id']."'";
				$result=mysql_query($query);
				 echo "<script language='javascript' type='text/javascript'>alert('Event Details Updated sucsessfully');</script>";		 
				 echo"<script language='javascript' type='text/javascript'>document.location='events.php';</script>";
				exit;			
		 ...
		 $query="insert into events(state_code,city_id,title,category,details,address,url,email_id,sdate,edate,status,image,other_details,date,time) values('".$a."','".$b."','".$c."','".$d."','".$details."','".$add."','".$url."','".$email_ID."','".$sd."','".$ed."','".$status."','".$image."','".$others."','".$date."','".$time."')";		 
		 $result=mysql_query($query);
		 echo "<script language='javascript' type='text/javascript'>alert('Event added sucsessfully');</script>";		 
		 echo"<script language='javascript' type='text/javascript'>document.location='events.php';</script>";
		 exit;	 
...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?> Event | NRIs</title>            
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="dashboard.php">Home</a></li>     
                      <li><a href="events.php">State Famous Places</a></li>                     
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?>Event Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php 			
                                ...
                                //    $query="select * from events where state_code='".$_GET['editId']."'";
								 $query="select a.*, b.state from events a, states b where a.state_code = b.state_code and a.id = '".$_GET['editId']."'";
							//	 echo $query;
                                    $result=mysql_query($query);
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?></strong> Event</h3>
                                 </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Event Title</span>                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Event Category</label>
                                                <div class="col-md-6 col-xs-12"> 
                                                ...
                                                <span class="help-block">Select Event Category</span>
                                                </div> 
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Event Address</span>                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Event URL</span>                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Status</label>
                                                ...
                                                <span class="help-block">Select Event Status</span>
                                                </div>
                                            </div>
                                ...
                                <img src="uploads/events/<?php echo $rs['image'];?>" height="60" width="auto" style="padding:5px 5px 5px 5px;">	<?php }   ?>
                                            <span class="help-block">Event Image</span>                                        </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" type="submit" name="submit" id="submit"><?php if(isset($_GET['editId'])) { echo "Update "; } else { echo "Add "; } ?> Event Details</button>
                                </div>
                            </div>
                            </form>
                        </div>
