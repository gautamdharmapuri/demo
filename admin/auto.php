...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Auto Classifieds Management | NRIs</title>            
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Auto  Classifieds</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <h3><img src="img/hand.gif"><a href="auto_details.php" class="mylink">Add Auto Classified</a></h3>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-car"></span>  <strong>Auto </strong> Classifieds</h3>
										...
										<div class="col-md-2 col-xs-12" style="float:right">
												<script type="text/javascript">
													  function change_state() {
															...
															if (sel != '') {
																  window.location.href = admin_url+'auto.php?state='+sel;    
                                                            } else {
																  window.location.href = admin_url+'auto.php';
															}
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" name="state_filter" onchange="change_state();">
													  ...
													  <?php
															$query1 = "SELECT a.* FROM post_free_auto a WHERE a.States != '' GROUP BY a.States ORDER BY States ASC";
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <?php
												...
												$query="select a.*, b.name, c.model_name from post_free_auto a,
												auto_makes b, auto_models c
												where a.Brand = b.id and a.SubBrand=c.id $where
												order by a.id desc";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ucwords($rs['BCondition']);?></td>
                                                <td><?php echo $rs['Year'];?></td>
                                                <td><?php echo strtoupper($rs['States']); ?></td>
                                               
                                                <td>
			                                <a class="btn btn-danger" style="background-color:#0066CC;border:#0066CC;padding:4px 10px;" title="View" href="auto_view.php?action=edit&editId=<?php echo $rs['id'];?>">
                                            <span class="fa fa-eye" style="margin-right:0px;"></span>
                                            </a>  
                                            
                                             &nbsp;&nbsp;
                                                <a class="btn btn-danger" style="background-color:#FF0000;border:#0066CC;" title="Delete"  href="auto.php?delId=<?php echo $rs['id'];?>" onClick="return delthis();" ><span class="fa fa-trash-o" style="margin-right:0px;"></span>
                                            </a>
                                                                                      </td>
                                            </tr>
                                          <?php $i++; }?>  
