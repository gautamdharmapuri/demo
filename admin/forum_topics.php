...
<?php  if (isset($_GET['delId']))
		...
		$qy="delete from  forum_threads where md5(id)='".$_GET['delId']."'";
		mysql_query($qy);
                    ...
                    <h3><img src="img/hand.gif"><a href="auto_details.php" class="mylink">Add Auto Classified</a></h3>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-users"></span>  <strong>Forum </strong>Threads</h3>
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
			                                <a class="btn btn-danger" title="Edit" href="forum_topic_details.php?action=edit&editId=<?php echo $rs['id'];?>">
                                            <span class="fa fa-pencil-square-o" style="margin-right:0px;"></span>
                                             ...
                                             &nbsp;&nbsp;
                                                <a class="btn btn-danger" style="background-color:#FF0000;border:#0066CC;" title="Delete"  href="forum_topics.php?delId=<?php echo md5($rs['id']);?>" onClick="return delthis();" ><span class="fa fa-trash-o" style="margin-right:0px;"></span>
                                            </a>
                                                                                      </td>
                                            </tr>
                                          <?php $i++; }?>  
