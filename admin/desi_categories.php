            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <div class="page-title">                    
                    <h3><img src="img/hand.gif"><a href="desi_category_details.php" class="mylink">Add New Desi Page Category</a></h3>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-globe"></span>  <strong>Desi Page </strong> Categories</h3>
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <?php
                                                $i=1;
												 ...
												 $query="select * from desi_pages_cat order by id desc";
                                            ...
                                            <tr>
                                                ...
                                                <td>
			                                <a class="btn btn-danger" title="Edit" style="padding:4px 10px;" href="desi_category_details.php?action=edit&editId=<?php echo $rs['id'];?>">
