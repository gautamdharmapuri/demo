...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Famous Restaurant | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Restaurant Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['rest_name']); ?> - Restaurant Details</h3>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <thead>
                                            <tr>
                                                ...
                                                <th><?php echo ucwords($rs['rest_name']); ?></th>                                               
                                            </tr>
                                        </thead>
                                       ...
                                       <tr>
                                                ...
                                                <th><?php echo ucwords($rs['rest_type']); ?></th>                                               
                                       </tr>  
                                       
                                    
                                    <thead>
                                        <tr>
                                            <th>Restaurant Conatct No</th>                      
		...
		<?php echo ucwords($rs['address']); ?>
                                   ...
                                   <thead>
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/restaurants/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="restaurants.php">Back</a>
                                        </a>
                                        </div>
