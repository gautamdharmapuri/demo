...
if(isset($_POST['submit']))
	{ 
			if($_POST['action']=='edit')
			{
				...
				$query="update   forum_thread_comment set comment ='".$a."',reply_status='".$status."' where cmnt_id='".$_POST['id']."'";
				$result=mysql_query($query);				
				 echo "<script language='javascript' type='text/javascript'>alert('Forum Thread Reply Updated sucsessfully');</script>";		 
...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?> Forum Thread Reply | NRIs</title>            
        ...
        <div class="page-container page-navigation-top">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?>Forum Thread Reply</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            <?php 			
                                  ...
                                  //  $query="select * from  forum_threads where id='".$_GET['editId']."'";
								    $query="select a.*, b.title, c.* from forum_thread_comment a, forum_threads b, register c where a.thread_Pid =  b.id and a.member_id = c.id  and  a.cmnt_id='".$_GET['editId']."'";
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?></strong> Forum Thread Reply</h3>
