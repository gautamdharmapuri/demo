...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Events | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Events Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-10">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['title']); ?> - Events Details</h3>
                                </div>
		...
		<?php echo ucwords($rs['address']); ?>
                                   ...
                                   <thead> 
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/events/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="events.php">Back</a>
                                        </a>
                                        </div>
