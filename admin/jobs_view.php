...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Job Classifieds Management | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                      <li><a href="jobs.php">Job Classifieds</a></li>                     
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Job Classifieds Management</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-8">
                            <?php 			
                                ...
                                //    $query="select * from fam_temples where state_code='".$_GET['editId']."'";
								 $query="select a.*, b.name, c.role from post_free_job a, job_category b, job_role c where a.Category = b.id and a.Job_Role=c.id and a.id = '".$_GET['editId']."'"; 
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php  if($rs['AdPostType']!='') {    echo "<b>".ucwords($rs['AdPostType'])."</b>" ; } else { echo "Free" ; } ?> AD - Job Classifieds
                                     ...
                                     <thead>
                                       ...
                                       <thead>
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="../uploads/jobs/<?php echo $rs['image1'];?>" width="250" height="auto"> 	<?php }  else {  ?>
                                           ...
                                           <?php } ?>
                             			   ...
                             			   <img src="../uploads/jobs/<?php echo $rs['image2'];?>" width="250" height="auto"> 	<?php }   ?>
                                           
                                           
                                            <?php   if (strpos($rs['image3'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image3'];?>" width="250" height="auto"> 	<?php }  ?>
											 
										   
										   <?php if (strpos($rs['image4'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image4'];?>" width="250" height="auto"> 	<?php }  ?>
                                           
                                           <?php  if (strpos($rs['image5'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image5'];?>" width="250" height="auto"> 	<?php }  ?>
                                           
                                            <?php  if (strpos($rs['image6'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image6'];?>" width="250" height="auto"> 	<?php } ?>
                                           
                                            <?php  if (strpos($rs['image7'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image7'];?>" width="250" height="auto"> 	<?php }  ?>
                                           
                                           
                                            <?php  if (strpos($rs['image8'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image8'];?>" width="250" height="auto"> 	<?php } ?>
                                           
                                           
                                            <?php  if (strpos($rs['image9'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image9'];?>" width="250" height="auto"> 	<?php } ?>
                                           
                                           
                                            <?php  if (strpos($rs['image10'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image10'];?>" width="250" height="auto"> 	<?php } ?>
                                           
                                            <?php  if (strpos($rs['image11'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image11'];?>" width="250" height="auto"> 	<?php } ?>                                           
                                           
                                           <?php  if (strpos($rs['image12'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image12'];?>" width="250" height="auto"> 	<?php } ?>                                           
                                           
											<?php  if (strpos($rs['image13'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image13'];?>" width="250" height="auto"> 	<?php } ?>                                                                                      
                                           
											<?php  if (strpos($rs['image14'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image14'];?>" width="250" height="auto"> 	<?php } ?>
                                           
                                           <?php  if (strpos($rs['image15'],'.') !== false) {  ?>
                             			   <img src="../uploads/jobs/<?php echo $rs['image15'];?>" width="250" height="auto"> 	<?php } ?>
                                        ...
                                        <a class="btn btn-info" href="jobs.php">Back</a>
                                        </a>
                                        </div>
