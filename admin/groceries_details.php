...
if(isset($_POST['submit']))
	{ 
			if($_POST['action']=='edit')
			{
				...
				$query="update fam_groceries set state_code='".$a."',city_id='".$b."',name='".$c."',contact='".$ph."',address='".$add."',url='".$url."',email_id='".$email_ID."',status='".$status."',image='".$image."',other_details='".$others."',date='".$date."',time='".$time."' where id='".$_POST['id']."'";
				$result=mysql_query($query);
				 echo "<script language='javascript' type='text/javascript'>alert('Grocery Details Updated sucsessfully');</script>";		 
				 echo"<script language='javascript' type='text/javascript'>document.location='groceries.php';</script>";
				exit;			
		 ...
		 $query="insert into  fam_groceries(state_code,city_id,name,contact,address,url,email_id,status,image,other_details,date,time) values('".$a."','".$b."','".$c."','".$ph."','".$add."','".$url."','".$email_ID."','".$status."','".$image."','".$others."','".$date."','".$time."')";		 
		 $result=mysql_query($query);
		 echo "<script language='javascript' type='text/javascript'>alert('Grocery added sucsessfully');</script>";		 
		 echo"<script language='javascript' type='text/javascript'>document.location='groceries.php';</script>";
		 exit;	 
...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?> Famous Grocery | NRIs</title>            
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="dashboard.php">Home</a></li>     
                      <li><a href="groceries.php">State Famous Places</a></li>                     
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?>Grocery Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php 			
                                ...
                                //    $query="select * from fam_groceries where state_code='".$_GET['editId']."'";
								 $query="select a.*, b.state from fam_groceries a, states b where a.state_code = b.state_code and a.id = '".$_GET['editId']."'";
							//	 echo $query;
                                    $result=mysql_query($query);
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?></strong> Grocery</h3>
                                 </div>
                                ...
                                <div class="panel-body">                                                                        
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Grocery Name</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="txtemplenm" id="txtemplenm" class="form-control" value="<?php echo $rs['name']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Grocery Name</span>                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Grocery Conatct No</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-phone"></span></span>
                                                <input type="text" name="txtph" id="txtph" class="form-control" value="<?php echo $rs['contact']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Grocery Conatct No</span>                                        </div>
                                    </div>        
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> Grocery Address</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="txtdesc" id="txtdesc" rows="5"><?php echo $rs['address']; ?></textarea>
                                            <span class="help-block">Grocery Address</span>                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Grocery URL (If any)</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-globe"></span></span>
                                                <input type="text" name="txturl" id="txturl" class="form-control" value="<?php echo $rs['url']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Grocery URL</span>                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Status</label>
                                                ...
                                                <span class="help-block">Select Grocery Status</span>
                                                </div>
                                            </div>
                                    
                                    <?php /*?><div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">grocery Image</label>
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <span class="help-block">Upload grocery image</span>                                        </div>
                                   ...
                                   <input type="file" class="fileinput btn-primary" name="txtimage" id="txtimage" title="Browse file"/>
                                             <?php   if (strpos($rs['image'],'.') !== false) {  ?>
                                <img src="uploads/groceries/<?php echo $rs['image'];?>" height="60" width="auto" style="padding:5px 5px 5px 5px;">	<?php }   ?>
                                            <span class="help-block">Grocery Image</span>                                        </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" type="submit" name="submit" id="submit"><?php if(isset($_GET['editId'])) { echo "Update "; } else { echo "Add "; } ?> Grocery Details</button>
                                </div>
                            </div>
                            </form>
                        </div>
