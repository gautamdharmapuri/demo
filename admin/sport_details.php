...
if(isset($_POST['submit']))
	{ 
			if($_POST['action']=='edit')
			{
				...
				$img="uploads/sports/".$image;
				move_uploaded_file($_FILES['txtimage']['tmp_name'],$img);		
				$img=$_FILES['txtimage']['name'];	
				if($img != ''){unlink('uploads/sports/'.$_POST['imgId']);}
				if($img == ''){$img=$_POST['imgId'];}
				}else
				$image=$_POST['imgId'];				
									
						
				$query="update fam_sports set state_code='".$a."',city_id='".$b."',name='".$c."',sport_type='".$d."',contact='".$ph."',address='".$add."',url='".$url."',email_id='".$email_ID."',status='".$status."',image='".$image."',other_details='".$others."',date='".$date."',time='".$time."' where id='".$_POST['id']."'";
				$result=mysql_query($query);
				 echo "<script language='javascript' type='text/javascript'>alert('Sport Details Updated sucsessfully');</script>";		 
				 echo"<script language='javascript' type='text/javascript'>document.location='sports.php';</script>";
				exit;			
		 ...
		 $query="insert into  fam_sports(state_code,city_id,name,sport_type,contact,address,url,email_id,status,image,other_details,date,time) values('".$a."','".$b."','".$c."','".$d."','".$ph."','".$add."','".$url."','".$email_ID."','".$status."','".$image."','".$others."','".$date."','".$time."')";		 
		 $result=mysql_query($query);
		 echo "<script language='javascript' type='text/javascript'>alert('Sport added sucsessfully');</script>";		 
		 echo"<script language='javascript' type='text/javascript'>document.location='sports.php';</script>";
		 exit;	 
...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?> Famous Sport | NRIs</title>            
...
<script language="javascript" type="text/javascript">
	function frmchk()
	{
		...
		{
			alert('Please Select Sport Status');			
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="dashboard.php">Home</a></li>     
                      <li><a href="sports.php">State Famous Places</a></li>                     
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?>Sport Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php 			
                                ...
                                //    $query="select * from fam_sports where state_code='".$_GET['editId']."'";
								 $query="select a.*, b.state from fam_sports a, states b where a.state_code = b.state_code and a.id = '".$_GET['editId']."'";
							//	 echo $query;
                                    $result=mysql_query($query);
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?></strong> Sport</h3>
                                 </div>
                                ...
                                <div class="panel-body">                                                                        
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Sport Name</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="txtemplenm" id="txtemplenm" class="form-control" value="<?php echo $rs['name']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Sport Name</span>                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Sport Type</label>
                                                <div class="col-md-6 col-xs-12"> 
                                                <select class="form-control select" data-style="btn-success" name="txtttype" id="txtttype">                                                     	<?php
													   	if(isset($rs['sport_type']))
														{?>
                                                        <option value="<?php echo $rs['sport_type']; ?>" selected ><?php echo $rs['sport_type']; ?></option
                                                         ><?php }  ?>
                                                         
                                                         
                                                         <option value="">- Select Sport Type -</option>
                                                         <option value="Tennis Clubs">Tennis Clubs</option>
                                                         <option value="Cricket Clubs">Cricket Clubs</option>
                                                         <option value="Shuttle (Badminton)">Shuttle (Badminton)</option>
                                                         <option value="Board Games (Carom Board, Chess, Checkers, Brain Vita)">Board Games (Carom Board, Chess, Checkers, Brain Vita)</option>
                                                ...
                                                <span class="help-block">Select Sport Type</span>
                                                </div>
                                            </div>
                                            
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Organization Conatct No</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-phone"></span></span>
                                                <input type="text" name="txtph" id="txtph" class="form-control" value="<?php echo $rs['contact']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Organization Conatct No</span>                                        </div>
                                    </div>        
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> Organization Address</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="txtdesc" id="txtdesc" rows="5"><?php echo $rs['address']; ?></textarea>
                                            <span class="help-block">Organization Address</span>                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            ...
                                            <span class="help-block">Sport URL</span>                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Status</label>
                                                ...
                                                <span class="help-block">Select Sport Status</span>
                                                </div>
                                            </div>
                                    
                                    <?php /*?><div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Sport Image</label>
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <span class="help-block">Upload Sport image</span>                                        </div>
                                   ...
                                   <input type="file" class="fileinput btn-primary" name="txtimage" id="txtimage" title="Browse file"/>
                                             <?php   if (strpos($rs['image'],'.') !== false) {  ?>
                                <img src="uploads/sports/<?php echo $rs['image'];?>" height="60" width="auto" style="padding:5px 5px 5px 5px;">	<?php }   ?>
                                            <span class="help-block">Sport Image</span>                                        </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" type="submit" name="submit" id="submit"><?php if(isset($_GET['editId'])) { echo "Update "; } else { echo "Add "; } ?> Sport Details</button>
                                </div>
                            </div>
                            </form>
                        </div>
