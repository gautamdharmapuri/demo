...
if(isset($_POST['submit']))
	{ 
			if($_POST['action']=='edit')
			{
				...
				$img="uploads/restaurants/".$image;
				move_uploaded_file($_FILES['txtimage']['tmp_name'],$img);		
				$img=$_FILES['txtimage']['name'];	
				if($img != ''){unlink('uploads/restaurants/'.$_POST['imgId']);}
				if($img == ''){$img=$_POST['imgId'];}
				}else
				$image=$_POST['imgId'];				
									
						
				$query="update fam_restaurants set state_code='".$a."',city_id='".$b."',rest_name='".$c."',rest_type='".$d."',contact='".$ph."',address='".$add."',url='".$url."',email_id='".$email_ID."',status='".$status."',image='".$image."',other_details='".$others."',date='".$date."',time='".$time."' where id='".$_POST['id']."'";
				$result=mysql_query($query);
				 echo "<script language='javascript' type='text/javascript'>alert('Restaurant Details Updated sucsessfully');</script>";		 
				 echo"<script language='javascript' type='text/javascript'>document.location='restaurants.php';</script>";
				exit;			
		 ...
		 $query="insert into  fam_restaurants(state_code,city_id,rest_name,rest_type,contact,address,url,email_id,status,image,other_details,date,time) values('".$a."','".$b."','".$c."','".$d."','".$ph."','".$add."','".$url."','".$email_ID."','".$status."','".$image."','".$others."','".$date."','".$time."')";		 
		 $result=mysql_query($query);
		 echo "<script language='javascript' type='text/javascript'>alert('Restaurant added sucsessfully');</script>";		 
		 echo"<script language='javascript' type='text/javascript'>document.location='restaurants.php';</script>";
		 exit;	 
...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?> Famous Restaurant | NRIs</title>            
...
<script language="javascript" type="text/javascript">
	function frmchk()
	{
		...
		{
			alert('Please Select Restaurant Status');			
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="dashboard.php">Home</a></li>     
                      <li><a href="restaurants.php">State Famous Places</a></li>                     
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?>Restaurant Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php 			
                                ...
                                //    $query="select * from fam_restaurants where state_code='".$_GET['editId']."'";
								 $query="select a.*, b.state from fam_restaurants a, states b where a.state_code = b.state_code and a.id = '".$_GET['editId']."'";
							//	 echo $query;
                                    $result=mysql_query($query);
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?></strong> Restaurant</h3>
                                 </div>
                                ...
                                <div class="panel-body">                                                                        
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Restaurant Name</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="txtemplenm" id="txtemplenm" class="form-control" value="<?php echo $rs['rest_name']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Restaurant Name</span>                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Restaurant Type</label>
                                                <div class="col-md-6 col-xs-12"> 
                                                <select class="form-control select" data-style="btn-success" name="txtttype" id="txtttype">                                                     	<?php
													   	if(isset($rs['rest_type']))
														{?>
                                                        <option value="<?php echo $rs['rest_type']; ?>" selected ><?php echo $rs['rest_type']; ?></option
                                                         ><?php }  ?>
                                                         ...
                                                         <option value="French Restaurants" >French Restaurants</option>
                                                         <option value="Spanish Restaurants" >Spanish Restaurants</option>
                                                         <option value="Other" >Other</option>
                                                         
                                                 
                                                        </select>
                                                <span class="help-block">Select Restaurant Type</span>
                                                </div>
                                            </div>
                                            
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Restaurant Conatct No</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-phone"></span></span>
                                                <input type="text" name="txtph" id="txtph" class="form-control" value="<?php echo $rs['contact']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Restaurant Conatct No</span>                                        </div>
                                    </div>        
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> Restaurant Address</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="txtdesc" id="txtdesc" rows="5"><?php echo $rs['address']; ?></textarea>
                                            <span class="help-block">Restaurant Address</span>                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Restaurant URL (If any)</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-globe"></span></span>
                                                <input type="text" name="txturl" id="txturl" class="form-control" value="<?php echo $rs['url']; ?>"/>
                                            </div>                                            
                                            <span class="help-block">Restaurant URL</span>                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                               <label class="col-md-3 col-xs-12 control-label">Status</label>
                                                ...
                                                <span class="help-block">Select Restaurant Status</span>
                                                </div>
                                            </div>
                                    
                                    <?php /*?><div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Restaurant Image</label>
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <span class="help-block">Upload Restaurant image</span>                                        </div>
                                   ...
                                   <input type="file" class="fileinput btn-primary" name="txtimage" id="txtimage" title="Browse file"/>
                                             <?php   if (strpos($rs['image'],'.') !== false) {  ?>
                                <img src="uploads/restaurants/<?php echo $rs['image'];?>" height="60" width="auto" style="padding:5px 5px 5px 5px;">	<?php }   ?>
                                            <span class="help-block">Restaurant Image</span>                                        </div> 
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" type="submit" name="submit" id="submit"><?php if(isset($_GET['editId'])) { echo "Update "; } else { echo "Add "; } ?> Restaurant Details</button>
                                </div>
                            </div>
                            </form>
                        </div>
