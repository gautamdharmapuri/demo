...
<?php  if (isset($_GET['delId']))
		...
		$temp="select image1 from post_free_mypart where id='".$_GET['delId']."'";
		$run=mysql_query($temp);
		$ans=mysql_fetch_array($run);
	
		unlink('../uploads/my_partner/'.$ans['image']);

		
		
		$qy="delete from post_free_mypart where id='".$_GET['delId']."'";
		mysql_query($qy);
		
	
		echo "<script language='javascript' type='text/javascript'>alert('My Partner Ads Deleted Successfully...');</script>";
		echo "<script language='javascript' type='text/javascript'>document.location='mypartner.php';</script>";
		exit;
} ?>
...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title>My Partner Classifieds Management | NRIs</title>            
...
<script language="javascript" type="text/javascript">
	function delthis()
	{	
		var ans=confirm("Are you sure You want to Delete this My Partner Ad\?");
		if (ans==true)
		{
			return true;
		}
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">My Partner Classifieds</li>
                </ul>
                <!-- END BREADCRUMB -->
 ...
 <?php /*?><div class="page-title">                    
                    <h3><img src="img/hand.gif"><a href="Jobs_details.php" class="mylink">Add My Partner  Classified</a></h3>
                </div><?php */?>

                            <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-users"></span>  <strong>My Partner </strong> Classifieds</h3>
                                    ...
                                    <div class="col-md-2 col-xs-12" style="float:right">
												<script type="text/javascript">
													  function change_state() {
															...
															if (sel != '') {
																  window.location.href = admin_url+'mypartner.php?state='+sel;    
                                                            } else {
																  window.location.href = admin_url+'mypartner.php';
															}
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" name="state_filter" onchange="change_state();">
													  ...
													  <?php
															$query1 = "SELECT a.* FROM post_free_mypart a WHERE a.States != '' GROUP BY a.States ORDER BY States ASC";
                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
                                        ...
                                        <?php
												...
												$query="select a.*, b.name from post_free_mypart a,  my_partner b
                                            ...
                                            <tr>
                                                ...
                                                <td>
			                                <a class="btn btn-danger" title="Edit" href="mypartner_view.php?action=edit&editId=<?php echo $rs['id'];?>">
