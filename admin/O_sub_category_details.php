...
<script language="javascript" type="text/javascript">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <select class="form-control select" data-style="btn-success" id="dhtmlgoodies_country" name="dhtmlgoodies_country" onchange="getCityList(this)">                                 <option value="">Select a country</option>
                                <?php
								$query_cat = "select * from main_categories order by name";  
								$data = mysql_query($query_cat);
                                ...
                                <select class="form-control select" data-style="btn-success" id="dhtmlgoodies_city" name="dhtmlgoodies_city">
                                </select>
    ...
    <!-- START SCRIPTS -->
       ...
       <?php /*?> <script type="text/javascript" src="js/plugins.js"></script>   <?php */?>     
