...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Videos Management | NRIs</title>            
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <div class="page-title">                    
                    <h3><img src="img/hand.gif"><a href="video_details.php" class="mylink">Add Videos</a></h3>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-play"></span>  <strong>Manage Videos</strong> Details</h3>
                                </div>
                                <div class="panel-body">
                                    <table class="table datatable">
                                        ...
                                        <?php
											...
											//	 $query="select a.*, b.state from  videos a, states b where a.state_code = b.state_code order by a.id desc";
                                            ...
                                            <tr>
                                                <td><?php echo $i;?></td>                                              
                                                <td><?php echo ucwords($rs['language']);?></td>
