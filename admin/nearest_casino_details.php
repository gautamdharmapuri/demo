...
if(isset($_POST['submit']))
	{ 
			if($_POST['action']=='edit')
			{
				...
				$query="update fam_near_casinos set state_code='".$a."',city_id='".$b."',name='".$c."',contact='".$ph."',address='".$add."',url='".$url."',email_id='".$email_ID."',status='".$status."',image='".$image."',other_details='".$others."',date='".$date."',time='".$time."' where id='".$_POST['id']."'";
				$result=mysql_query($query);
				 echo "<script language='javascript' type='text/javascript'>alert('Casinos Near Me Details Updated sucsessfully');</script>";		 
		 ...
		 $query="insert into  fam_near_casinos(state_code,city_id,name,contact,address,url,email_id,status,image,other_details,date,time) values('".$a."','".$b."','".$c."','".$ph."','".$add."','".$url."','".$email_ID."','".$status."','".$image."','".$others."','".$date."','".$time."')";		 
		 $result=mysql_query($query);
		 echo "<script language='javascript' type='text/javascript'>alert('Casinos Near Me added sucsessfully');</script>";		 
		 echo"<script language='javascript' type='text/javascript'>document.location='nearest_casinos.php';</script>";
		 exit;	 
...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?> Famous Casinos Near Me | NRIs</title>            
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="dashboard.php">Home</a></li>     
                      <li><a href="nearest_casinos.php">State Famous Places</a></li>                     
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "Edit "; } else { echo "Add  "; } ?>Casinos Near Me Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php 			
                                ...
                                //    $query="select * from fam_near_casinos where state_code='".$_GET['editId']."'";
								 $query="select a.*, b.state from fam_near_casinos a, states b where a.state_code = b.state_code and a.id = '".$_GET['editId']."'";
							//	 echo $query;
                                    $result=mysql_query($query);
