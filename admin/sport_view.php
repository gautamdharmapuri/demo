...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Famous Sport | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Sport Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['name']); ?> - Sport Details</h3>
                                </div>
                                ...
                                <div class="panel-body panel-body-table">                                
                                    <table class="table table-bordered">
                                      ...
                                      <thead>
                                       ...
                                       <tr>
                                                <th>Sport Type</th>                      
                                                <th><?php echo ucwords($rs['sport_type']); ?></th>                                               
                                       </tr>  
                                       
                                    
                                    <thead>
                                        <tr>
                                            <th>Organization Conatct No</th>                      
                                   ...
                                   <thead>
                                       ...
                                       <thead>
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/sports/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="sports.php">Back</a>
                                        </a>
                                        </div>
