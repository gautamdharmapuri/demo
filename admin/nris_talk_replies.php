...
<?php  if (isset($_GET['delId']))
		...
		echo "<script language='javascript' type='text/javascript'>alert('NRIs Talk Reply Deleted Successfully...');</script>";
                    ...
                    <h3><img src="img/hand.gif"><a href="auto_details.php" class="mylink">Add Auto Classified</a></h3>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-users"></span>  <strong>NRIs Talk</strong>Threads Replies</h3>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <?php
											...
											//	$query="select a.*, b.fname,b.lname, c.sub_cat_name from nris_talk a, register b, forum_sub_categories c where a.category_id = c.sub_id and a.member_id = b.id order by a.id desc";
												$query="select a.*, b.fname,b.lname, d.title from nris_talk_comment a, register b, nris_talk d where a.member_id = b.id and a.thread_Pid =  d.id order by a.cmnt_id desc";
                                            ...
                                            <tr>
                                                ...
                                                <td>
			                                <a class="btn btn-danger" title="Edit" href="nris_talk_reply_details.php?action=edit&editId=<?php echo $rs['cmnt_id'];?>">
                                            <span class="fa fa-pencil-square-o" style="margin-right:0px;"></span>
                                             ...
                                             &nbsp;&nbsp;
                                                <a class="btn btn-danger" style="background-color:#FF0000;border:#0066CC;" title="Delete"  href="nris_talk_replies.php?delId=<?php echo md5($rs['cmnt_id']);?>" onClick="return delthis();" ><span class="fa fa-trash-o" style="margin-right:0px;"></span>
                                            </a>
                                                                                      </td>
                                            </tr>
                                          <?php $i++; }?>  
