                                ...
                                <div class="col-md-2 col-xs-12" style="float:right">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" name="state_filter" onchange="change_state();">
													  ...
													  <?php
															$query1 = "SELECT a.state_code,s.state FROM fam_temples a,states s WHERE a.state_code = s.state_code AND a.state_code != '' GROUP BY a.state_code ORDER BY a.state_code ASC";
