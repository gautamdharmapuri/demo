            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Casinos Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['name']); ?> - Casinos Details</h3>
                                </div>
		...
		<?php echo ucwords($rs['address']); ?>
                                 ...
                                 <thead>   
                                   ...
                                   <thead> 
                                        ...
                                        <a class="btn btn-info" href="casinos.php">Back</a>
                                        </a>
                                        </div>
