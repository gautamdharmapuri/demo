...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> US Advertisement | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   ...
                   <li><a href="us_ads.php">Home Page Link</a></li>                 
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>US Ads Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['adv_name']); ?> - US Ads Details</h3>
                                </div>
                                ...
                                <div class="panel-body panel-body-table">                                
                                    <table class="table table-bordered">
                                      ...
                                      <thead>
                                            <tr>
                                                <th style="width:20%;">Advertiser Name</th>                      
                                   ...
                                   <tr>
                                      ...
                                      <thead>
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/us_ads/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="us_ads.php">Back</a>
                                        </a>
                                        </div>
