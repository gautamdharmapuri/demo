...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Famous Temple | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Temple Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['temple_name']); ?> - Temple Details</h3>
                                </div>
                                ...
                                <div class="panel-body panel-body-table">                                
                                    <table class="table table-bordered">
                                      ...
                                      <thead>
                                            <tr>
                                                <th>Temple Name</th>                      
                                                <th><?php echo ucwords($rs['temple_name']); ?></th>                                               
                                            </tr>
                                        </thead>
                                       ...
                                       <tr>
                                                <th>Temple Type</th>                      
                                                <th><?php echo ucwords($rs['temple_type']); ?></th>                                               
                                       </tr>  
                                       
                                    
                                    <thead>
                                        <tr>
                                            <th>Temple Conatct No</th>                      
		...
		<?php echo ucwords($rs['address']); ?>
                                 ...
                                 <thead>
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/temples/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="temples.php">Back</a>
                                        </a>
                                        </div>
