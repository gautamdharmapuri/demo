...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Desi Page | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Desi Page Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['title']); ?> - Desi Page Details</h3>
                                </div>
                                ...
                                <div class="panel-body panel-body-table">                                
                                    <table class="table table-bordered">
                                      ...
                                      <thead>
                                       ...
                                       <tr>
                                                <th>Category</th>                      
                                                <th><?php echo ucwords($rs['category_name']); ?></th>                                               
                                       </tr>  
		...
		<?php echo ucwords($rs['address']); ?>
                                   ...
                                   <thead>
                                    ...
                                    <thead>
                                	  ...
                                	  <thead>
                                      <tr>
                                                <th style="width:15%;">Other Details</th>                      
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/desipages/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="desi_pages.php">Back</a>
                                        </a>
                                        </div>
