...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Advertisement with Us | NRIs</title>       
                        ...
                        <div class="col-md-8">
                            <?php 			
                                ...
                                //    $query="select * from fam_temples where state_code='".$_GET['editId']."'";
								 $query="select * from advertise_with_us where md5(id) = '".$_GET['editId']."'";
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Advertisement with Us  Details</h3>
                                </div>
                                ...
                                <div class="panel-body panel-body-table">                                
                                    <table class="table table-bordered">
                                         ...
                                         <thead>
                                            <tr>
                                                <th>Name</th>                      
                                                <th><?php echo ucwords($rs['fname']); ?>&nbsp;<?php echo ucwords($rs['lanem']); ?></th>                                               
                                            </tr>
                                        </thead>
                                    ...
                                    <thead>
                                        <tr>
                                            <th>Business</th>                      
                                            <th><?php echo ucwords($rs['business']);?></th>                                               
                                        </tr>
                                    </thead> 
                                     ...
                                     <tr>
                                      ...
                                      <thead>
                                        <tr>
                                            <th>Website</th>                      
                                            <th><?php echo strtolower($rs['website']); ?></th>                                                     
                                        </tr>
                                    </thead>   
                                  ...
                                  <tr>
                             			   ...
                             			   <img src="img/Advertise/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="ads_with_us.php">Back</a>
                                        </a>
                                        </div>
