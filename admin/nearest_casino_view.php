...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Famous Casinos | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Casinos Near Me Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <?php 			
                                ...
                                //    $query="select * from fam_Grocerys where state_code='".$_GET['editId']."'";
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['name']); ?> - Casinos Near Me Details</h3>
                                </div>
                                 ...
                                 <thead>   
                                   ...
                                   <thead> 
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/casinos/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="nearest_casinos.php">Back</a>
                                        </a>
                                        </div>
