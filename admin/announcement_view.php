...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?> Announcement | NRIs</title>       
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">Home</a></li>     
                    ...
                    <li class="active"><?php if(isset($_GET['editId'])) { echo "View "; } else { echo "Add  "; } ?>Announcement Details</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-10">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ucwords($rs['title']); ?> - Announcement Details</h3>
                                </div>
                                ...
                                <div class="panel-body panel-body-table">                                
                                 ...
                                 <thead>
                                        ...
                                        <tr>
                             			   ...
                             			   <img src="uploads/announcements/<?php echo $rs['image'];?>" width="300" height="auto"> 	<?php }  else {  ?>
                                        ...
                                        <a class="btn btn-info" href="announcements.php">Back</a>
                                        </a>
                                        </div>
