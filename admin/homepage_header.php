...
<?php  if (isset($_GET['delId']))
	  	{
		$temp="select image from homepage_header where id='".$_GET['delId']."'";
		$run=mysql_query($temp);
		$ans=mysql_fetch_array($run);
	
		unlink('uploads/us_ads/'.$ans['image']);
		$qy="delete from homepage_header where id='".$_GET['delId']."'";
		mysql_query($qy);
...
<html lang="en">
    <head><base href="/">        
        <!-- META SECTION -->
        <title>Home Page Header Management | NRIs</title>            
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <div class="page-title">                    
                    <h3><img src="img/hand.gif"><a href="homeheader_ad_details.php" class="mylink">Add Home Page Header</a></h3>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-file-image-o"></span>  <strong>Home Page Header</strong></h3>
                                </div>
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <?php
												...
												// $query="select a.*, b.state from us_ads a, states b where a.state_code = b.state_code order by a.id desc";
												 $query="select * from homepage_header  order by id desc";
                                ...
                                <img src="uploads/us_ads/<?php echo $rs['image'];?>" height="50" width="auto" style="padding:5px 5px 5px 5px;">	<?php }   ?></td>
			                                ...
			                                <a class="btn btn-danger" title="Edit" style="padding:4px 10px;" href="homeheader_ad_details.php?action=edit&editId=<?php echo $rs['id'];?>">
                                            ...
                                            { ?> 
                                            &nbsp;
                                             <a class="btn btn-danger" style="background-color:#FF0000;border:#0066CC;padding:4px 10px;" title="Delete" href="homepage_header.php?delId=<?php echo $rs['id'];?>" onClick="return delthis();" >
