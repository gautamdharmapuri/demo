...
<?php
	...
	$query = "select a.*, b.category_name from blog a, blog_categories b where a.category_id  = b.id and status = 'Publish' and md5(a.category_id) = '".$_SESSION['viewId']."'" ;
...
//	$total_pages = $total_pages[num];
    ...
    // Get page data
	$query1 = "select a.*, b.category_name from blog a, blog_categories b where a.category_id  = b.id  and status = 'Publish' and md5(a.category_id) = '".$_SESSION['viewId']."' LIMIT $start, $limit";
