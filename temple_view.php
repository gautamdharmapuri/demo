...
<!-- Section-1 START-->	
        ...
        <div class="col-md-8 inner-middle-wrap">
            ...
            <div class="col-md-12" style="text-align:left;color:#000000;"> 
                       ...
                       <a href="<?php echo $siteUrlConstant;?>" style="color:#0033FF;">Home</a> >> Temples >> 
					   <?php 
...
<p class="mydata" align="center" style="text-align:center;">
        ...
        <img alt="<?php echo ucwords($rs['temple_name']); ?>" src="admin/uploads/temples/<?php echo $rs['image'];?>" width="80%" style="height:400px !important;"  class="imgframe"> 	<?php }  else {  ?>
        <img alt="<?php echo ucwords($rs['temple_name']); ?>" src="admin/img/no_image.png" height="auto" width="300" class="imgframe">
        <?php } ?>
...
<p class="mydata"><b>Temple Type :</b> <?php echo ucwords($rs['temple_type']); ?><?php echo ucwords($rs['id']); ?></p>
