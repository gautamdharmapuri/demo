...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState;  ?> Top Rated Casinos View | NRIs</title>
...
<div class="widget-temple">
	...
	<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $defaultState;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant.'top_rated_casinos?code='.$state;?>" class="breadcumb_link">Top Rated Casinos</a> >> <?php echo ucwords($rs['name']); ?></h4>
</div>    <br>                          
...
<p class="mydata" align="center" style="text-align:center;">
        ...
        <img alt="<?php echo ucwords($rs['name']); ?>" src="admin/uploads/casinos/<?php echo $rs['image'];?>" width="80%" style="height:400px !important;"  class="imgframe"> 	<?php }  else {  ?>
...
<p class="mydata"><b>Casino Name :</b> <?php echo ucwords($rs['name']); ?></p>
     ...
     $('document').ready(function() {
		...
		$("#message").on('input propertychange',function() {
			...
			if (words > word_count) {
			  ...
			  $('#message1').text(word_count-words);
			}
		  });
