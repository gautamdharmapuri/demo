...
<head>
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $_SESSION['state'];  ?> Top Rated Casinos View | NRIs</title>
...
<div class="widget-temple">
	...
	<h4><a href="state.php?State=<?php echo $state;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo SITE_BASE_URL.'/top_rated_casinos.php?code='.$state;?>" class="breadcumb_link">Top Rated Casinos</a> >> <?php echo ucwords($rs['name']); ?></h4>
</div>    <br>                          
