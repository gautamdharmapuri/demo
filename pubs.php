...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title>Famous Pubs/Bars | NRIs</title>
...
<table align="center" >
    ...
    // Get page data
	$query1 = "SELECT DISTINCT  * FROM fam_pubs LEFT OUTER JOIN rating_pubs ON fam_pubs.id = rating_pubs.pub_id GROUP BY(fam_pubs.id) order by rating_pubs.rate desc, fam_pubs.total_views desc LIMIT $start, $limit";
	...
	{	
		...
		$paginate.= "</div>";		
				...
				{ ?> 
                            <tr>
                            <td style="padding:5px;"><img alt="<?php echo ucwords($rs['name']);?>" src="admin/uploads/pubs/<?php echo $rs['image'];?>" style="height:50px;width:50px;border-radius: 50%;"></td>
