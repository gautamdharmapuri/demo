...
<div class="menu-wrap clearfix">
  ...
  <li><a href="javascript:;">Movies/Videos </a>
        ...
        <li><a href="javascript:;"  data-toggle="modal" data-target="#change_state_studenttalk">Student's Talk</a>
        </li>
...
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-8">		
		...
		&nbsp;&nbsp;<a href="<?php echo $siteUrlConstant;?>forgot_password" class="read-btn-tab" style="float:right;">Forgot Password</a>
