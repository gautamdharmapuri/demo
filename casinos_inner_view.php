...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState;  ?> Casinos View | NRIs</title>
...
<div class="widget-temple">
	...
	<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $defaultState;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant.'casinos_inner?code='.$defaultState;?>" class="breadcumb_link">Casinos</a> >> <?php echo ucwords($rs['name']); ?></h4>
</div>    <br>                          
