		...
		{		
				//	$query = "select a.*, b.name from post_free_education a, eduation_teaching b where a.AdsCat = b.id  order by a.total_views desc";
					$query  = "select a.*, b.name from post_free_education a, eduation_teaching b where a.EndDate >= '".$current_date."' and a.AdsCat = b.id and a.States  IN ('ALL','multiple')   order by a.total_views desc";
						...
						{ ?> 
					<tr>                                                                             
					<td><a href="education_view.php?ViewId=<?php echo md5($rs['id']);?>"  onMouseMove="this.style.color='red'" onMouseOut="this.style.color='black'"><?php echo ucwords($rs['TitleAD']);?></a></td>
					<td><a href="education_view.php?ViewId=<?php echo md5($rs['id']);?>"  onMouseMove="this.style.color='red'" onMouseOut="this.style.color='black'"><?php echo ucwords($rs['name']);?></a></td>
					<td><a href="education_view.php?ViewId=<?php echo md5($rs['id']);?>"  onMouseMove="this.style.color='red'" onMouseOut="this.style.color='black'"><?php echo ucwords($rs['City']);?></a></td>
					<td><a href="education_view.php?ViewId=<?php echo md5($rs['id']);?>"  onMouseMove="this.style.color='red'" onMouseOut="this.style.color='black'"><?php  echo $rs['total_views'];?></a></td>
					</tr>
					<?php }   ?>
