...
<div class="widget-temple">
  ...
  <?php
		...
		{ ?>
<a href="javascript:;" data-toggle="modal" data-target="#premium_post"  class="btn btn-default" style="background-color:#0000FF;color:#FFFFFF;float:right;">Create Premium Post <img src="images/New_icon2.gif" alt="New"></a>    
<a href="javascript:;" data-toggle="modal" data-target="#free_post"  class="btn btn-default" style="background-color:#990033;color:#FFFFFF;float:right;">Create Free Post <img src="images/arrow.gif" alt=">"></a>    
  <?php } else { ?> 
