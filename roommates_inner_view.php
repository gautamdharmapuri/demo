...
<head>
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $_SESSION['state'];  ?> Room Mates Ad View | NRIs</title>
...
<h4><a href="state.php" style="color:#0033FF;">Home</a> >> Room Mates</h4>
  <?php
				...
				<div class="col-md-3" >
					<?php
						...
						if($rs['image'.$tempVar] != '') { ?>
							<div class="col-sm-12">
								<a href="javascript:;">
									<img class="myImageClass" src="<?php echo 'uploads/roommates/'.$rs['image'.$tempVar];?>" style="width:100%;height:140px;">
								</a>
							</div>
					<?php } ?>
				</div>
