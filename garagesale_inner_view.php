...
<head>
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $_SESSION['state'];  ?> Garage Sale Ad View | NRIs</title>
...
<!-- Section-1 START-->	
	...
	<h4><a href="state.php" style="color:#0033FF;">Home</a> >> Garage Sale</h4>

 <?php
if(isset($_SESSION['Nris_session']))	  
{ ?>
<a href="garagesale_create.php?code=<?php echo $_SESSION['state'] ?>&type=premium"  class="btn btn-default" style="background-color:#0000FF;color:#FFFFFF;float:right;">Create Premium Post <img src="images/New_icon2.gif"></a>    
