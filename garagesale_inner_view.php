...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState;  ?> Garage Sale Ad View | NRIs</title>
...
<!-- Section-1 START-->	
	...
	<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $defaultState;?>" style="color:#0033FF;">Home</a> >> Garage Sale</h4>

 <?php
if(isset($_SESSION['Nris_session']))	  
{ ?>
<a href="<?php echo $siteUrlConstant;?>garagesale_create?code=<?php echo $defaultState ?>&type=premium"  class="btn btn-default" style="background-color:#0000FF;color:#FFFFFF;float:right;">Create Premium Post <img src="images/New_icon2.gif" alt="New"></a>    
<a href="<?php echo $siteUrlConstant;?>garagesale_create?code=<?php echo $defaultState ?>"  class="btn btn-default" style="background-color:#990033;color:#FFFFFF;float:right;">Create Free Post <img src="images/arrow.gif" alt=">"></a>    
  <?php } else { ?> 
				...
				<div class="col-md-3" >
					<?php
						...
						if($rs['image'.$tempVar] != '') { ?>
							<div class="col-sm-12">
								<a href="javascript:;">
									<img class="myImageClass" src="<?php echo 'uploads/garage_sale/'.$rs['image'.$tempVar];?>" style="width:100%;height:140px;" alt="<?php echo ucwords($rs['TitleAD']);?>">
								</a>
							</div>
					<?php } ?>
				</div>
                                     ...
                                     <thead>
											...
											//	echo $items[0];
												...
												for($j=0; $j<=mysql_num_rows($resultcat); $j++)
												{
													if($items[$j]!='')
													{
														echo '<span style="clear:both;float:left;margin-bottom:3px;"><img src="admin/img/chk1.png" alt="'.ucwords($items[$j]).'"> '.ucwords($items[$j])." </span>";
													}	
												}
