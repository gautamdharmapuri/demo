...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title>Famous Temples | NRIs</title>
...
<div class="widget-temple">
	<h4><a href="<?php echo $siteUrlConstant;?>" style="color:#0033FF;">Home</a> >> Temples</h4>
</div>    <br>
...
//	$total_pages = $total_pages[num];
	...
	{	
		...
		$paginate.= "</div>";		
				...
				?> 
                            <tr>
                                <td style="padding:5px;"><img alt="<?php echo ucwords($rs['temple_name']);?>" src="admin/uploads/temples/<?php echo $rs['image'];?>" style="height:50px;width:50px;border-radius: 50%;"></td>
