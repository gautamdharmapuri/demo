...
<table align="center" >
	...
	{	
		...
		$paginate.= "</div>";		
				...
				{ ?> 
            <tr>
            <td style="padding:5px;"><a href="<?php echo $siteUrlConstant;?>groceries_view?ViewId=<?php echo md5($rs['id']);?>"><img src="admin/uploads/groceries/<?php echo $rs['image'];?>" style="height:50px;width:50px;border-radius: 50%;" alt="<?php echo ucwords($rs['name']);?>"></a></td>
