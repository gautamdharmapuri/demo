...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState ?> - Real Estate Ad | NRIs</title>
...
<div class="widget-temple">
	<?php $state = $defaultState;?>
				<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $state;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant.'realestate_inner?code='.$state;?>" class="breadcumb_link">Real Estate</a> >> Create Ad</h4>
</div><br>
...
<br style="clear:both;"><br><br><br><br><br><br>			
    ...
    <?php
		...
		if($final_count >= 3) {
			$url = 'adcheck?redirect=realestate_create&State='.$state;
