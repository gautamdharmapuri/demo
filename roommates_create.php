...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState ?> -Room Mates Create Ad | NRIs</title>
...
if(isset($_POST['Submit']))
{
	...
	$EndDate = test_input($_POST["EndDate"]);			
		...
		{			
			if($adPosttype!='')	
			{
							$query=mysql_query("insert into  post_free_roommates (TitleAD,Message,Category,gender_type,Rent,ConatctNAME,ConatctNumber,ConatctEmail,Contact_PID,ShowEmail,City,image1,image2,image3,image4,image5,image6,image7,image8,image9,image10,image11,image12,image13,image14,image15,AdPostType,URL,EndDate,date,time,States) VALUES('".$TitleAD."','".$Desrp."','".$Brand."','".$SubBrand."','".$Rent."','".$ConatctNAME."','".$ConatctNumber."','".$ConatctEmail."','".$pid."','".$ShowEmail."','".$City."','".$image1."','".$image2."','".$image3."','".$image4."','".$image5."','".$image6."','".$image7."','".$image8."','".$image9."','".$image10."','".$image11."','".$image12."','".$image13."','".$image14."','".$image15."','".$adPosttype."','".$URL."','".$EndDate."','".$date."','".$time."','".$state."')");
			}
			else
			{
		...
		if($_GET['type'] == 'premium') {
				...
				$type = 'roommates';
				$table_name = 'post_free_roommates';
				?>
...
<div class="widget-temple">
	<?php $state = $defaultState;?>
				<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $state;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant.'roommates_inner?code='.$state;?>" class="breadcumb_link">Room Mates</a> >> Create Ads</h4>
</div><br>
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="text" class="form-control" id="" pattern="[a-zA-Z0-9\s]+" required name="TitleAD" placeholder="Title Ad" style="width:100%;margin-bottom:0px;" maxlength="50" tabindex="1" onKeyUp="LimtCharacters(this,50,'lblcount');" required />               		
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<select name="Brand" id="Brand" required=""  class="form-control"  tabindex="3" >
                <option value="">Select Room Mate Type</option>
                <?php
					$query_brand="select * from  room_mates order by name";
...
<div class="col-md-6">
<div class="form-group">
	<label for="inputEmail3" class="col-sm-4 control-label"  style="text-align:left;font-size:10px;">Gender Preference for Roommates?</label>
	<div class="col-sm-8">
    	<select name="SubBrand" id="SubBrand" required=""  class="form-control"  tabindex="3" >
...
<div class="col-md-6">
<div class="form-group">
	<label for="inputEmail3" class="col-sm-4 control-label"  style="text-align:right;">Rent*</label>
	<div class="col-sm-8">
    	<input type="text" class="form-control" id="Rent" name="Rent" placeholder="Rent" style="width:100%;margin-bottom:0px;" tabindex="4" required />               		
	</div>
</div>
</div>
...
<br style="clear:both;"><br><br><br><br><br><br>			
    ...
    <?php
		...
		if($final_count >= 3) {
			$url = 'adcheck?redirect=roommates_create&State='.$state;
