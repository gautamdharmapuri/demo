...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title>Famous Restaurants | NRIs</title>
...
<div class="widget-temple">
	<h4><a href="<?php echo $siteUrlConstant;?>" style="color:#0033FF;">Home</a> >> Restaurants</h4>
</div>   <br>
...
<table align="center" >
    ...
    // Get page data
	$query1 = "SELECT DISTINCT  * FROM fam_restaurants LEFT OUTER JOIN rating_restaurant ON fam_restaurants.id = rating_restaurant.res_id GROUP BY(fam_restaurants.id) order by rating_restaurant.rate desc, fam_restaurants.total_views desc LIMIT $start, $limit";
	...
	{	
		...
		$paginate.= "</div>";		
				...
				{ ?> 
                            <tr>
                                <td style="padding:5px;"><img alt="<?php echo ucwords($rs['rest_name']);?>" src="admin/uploads/restaurants/<?php echo $rs['image'];?>" style="height:50px;width:50px;border-radius: 50%;"></td>
