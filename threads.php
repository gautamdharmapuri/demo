...
<a href="<?php echo $siteUrlConstant;?>create_forum?cat=<?php echo $fs['sub_id']; ?>"  class="btn btn-default" style="background-color:#0000FF;color:#FFFFFF;float:right;">Create Topic <img src="images/arrow.gif" alt=">"></a>    
  <?php } else { ?> 
<a href="javascript:;"  data-toggle="modal" data-target="#myModal" class="btn btn-default" style="background-color:#990033;color:#FFFFFF;float:right;" >Create Topic Ad&nbsp;<img src="images/arrow.gif" alt=">"></a>   
<?php } ?>                               
</div>    <br>
