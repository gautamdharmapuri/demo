...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState;  ?> Free Stuff Ad View | NRIs</title>
...
<!-- Section-1 START-->	
        ...
        <?php
			$query="select * from post_free_stuff where  md5(id) = '".$_GET['ViewId']."'"; 
			$result=mysql_query($query);
			$rs=mysql_fetch_array($result);	
			$total_views = $rs['total_views'] + 1 ;
			mysql_query("update post_free_stuff set total_views='".$total_views."' where md5(id) = '".$_GET['ViewId']."'");
...
<h4><a href="<?php echo $siteUrlConstant;?>state?Code=<?php echo $defaultState;?>" style="color:#0033FF;">Home</a> >> Free Stuff Ads</h4>
  <?php
