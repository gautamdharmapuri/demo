...
<!-- Section-1 START-->	
        ...
        <div class="col-md-8 inner-middle-wrap">
            ...
            <div class="col-md-12" style="text-align:left;color:#000000;"> 
                       ...
                       <br><?php 
					  	 $query="select a.*, b.state from announcement a, states b where a.state_code = b.state_code and md5(a.id) = '".$_GET['ViewId']."'";							
	
                                    $result=mysql_query($query);
                                    $rs=mysql_fetch_array($result);
								//	echo ucwords($rs['temple_name']); 
									$total_views = $rs['total_views'] + 1 ;
									mysql_query("update announcement set total_views='".$total_views."' where md5(id) = '".$_GET['ViewId']."'");
					    ?>
...
<p class="mydata" align="center" style="text-align:center;">
        ...
        <img src="admin/uploads/announcements/<?php echo $rs['image'];?>" width="80%" height="auto" class="imgframe" alt="<?php echo ucwords($rs['title']); ?>"> 	<?php }  else {  ?>
        <img src="admin/img/no_image.png" height="auto" width="300" class="imgframe" alt="No Image">
        <?php } ?>
...
<p class="mydata"><b>Details  :</b> <?php echo $rs['details']; ?></p>
<p class="mydata"><b>Email  :</b>
			<?php
            if(isset($_SESSION['Nris_session']))	  
            { echo ucwords($rs['email_id']);  } else { ?>
