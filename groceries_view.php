...
<!-- Section-1 START-->	
        ...
        <div class="col-md-8 inner-middle-wrap">
            ...
            <div class="col-md-12" style="text-align:left;color:#000000;"> 
                       ...
                       <br><?php 
					  	 $query="select a.*, b.state from fam_groceries a, states b where a.state_code = b.state_code and md5(a.id) = '".$_GET['ViewId']."'";							
	
                                    $result=mysql_query($query);
                                    $rs=mysql_fetch_array($result);
								//	echo ucwords($rs['temple_name']); 
									$total_views = $rs['total_views'] + 1 ;
									mysql_query("update fam_groceries set total_views='".$total_views."' where md5(id) = '".$_GET['ViewId']."'");
					    ?>
...
<p class="mydata" align="center" style="text-align:center;">
        ...
        <img src="admin/uploads/groceries/<?php echo $rs['image'];?>" width="80%" style="height:400px !important;"  class="imgframe" alt="<?php echo ucwords($rs['name']); ?>"> 	<?php }  else {  ?>
...
$date=date('Y-m-d');
$query_rate_before = mysql_query("select * from rating_grocery where login_id='".$myid."' and grocery_id ='".$pro_id."' ");

if(mysql_num_rows($query_rate_before)>0)
{
		 $query_rate = "update rating_grocery set grocery_id = '".$pro_id."', rate='".$star."', login_id = '".$myid."', login_name = '".$new_name."', date = '".$date."' where login_id='".$myid."' and grocery_id ='".$pro_id."'";		 
		 $result_rate = mysql_query($query_rate);
}
else
{
 $query_rate = "insert into rating_grocery(grocery_id,rate,login_id,login_name,date) values('".$pro_id."','".$star."','".$myid."','".$new_name."','".$date."')";		 
 $result_rate = mysql_query($query_rate);
}
...
<?php 
$star1 = "SELECT COUNT(id) AS star1Id FROM  rating_grocery WHERE grocery_id = '".$rs['id']."' and rate='1'";
$result_start1 = mysql_query($star1);
$star_fs1 = mysql_fetch_array($result_start1);

$star2 = "SELECT COUNT(id) AS star2Id FROM  rating_grocery WHERE grocery_id = '".$rs['id']."' and rate='2'";
$result_start2 = mysql_query($star2);
$star_fs2 = mysql_fetch_array($result_start2);

$star3 = "SELECT COUNT(id) AS star3Id FROM  rating_grocery WHERE grocery_id = '".$rs['id']."' and rate='3'";
$result_start3 = mysql_query($star3);
$star_fs3 = mysql_fetch_array($result_start3);

$star4 = "SELECT COUNT(id) AS star4Id FROM  rating_grocery WHERE grocery_id = '".$rs['id']."' and rate='4'";
$result_start4 = mysql_query($star4);
$star_fs4 = mysql_fetch_array($result_start4);

$star5 = "SELECT COUNT(id) AS star5Id FROM  rating_grocery WHERE grocery_id = '".$rs['id']."' and rate='5'";
