...
{ ?>
<a href="education_create.php?code=<?php echo $_SESSION['state'] ?>&type=premium"  class="btn btn-default" style="background-color:#0000FF;color:#FFFFFF;float:right;">Create Premium Post <img src="images/arrow.gif"></a>    
...
/*			$result_cat = mysql_query("select name from eduation_teaching where id='".$cat."' ");
	...
	//	echo $query2;
                                                                                ...
                                                                                { ?> 
                                                                            <tr>                                                                             
                                                <td><a href="education_inner_view.php?ViewId=<?php echo md5($rs['id']);?>"  onMouseMove="this.style.color='red'" onMouseOut="this.style.color='black'"><?php echo ucwords($rs['TitleAD']);?></a></td>
