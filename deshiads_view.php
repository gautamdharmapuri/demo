...
<head>
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $_SESSION['state'];  ?> Deshi Ads View | NRIs</title>
...
<div class="widget-temple">
	<h4><a href="state.php" style="color:#0033FF;">Home</a> >> Deshi Ads >> <?php echo ucwords($rs['title']); ?></h4>
</div>    <br>                          
...
<p class="mydata" align="center" style="text-align:center;">
        ...
        <img src="admin/uploads/desipages/<?php echo $rs['image'];?>" width="80%" style="height:400px !important;" class="imgframe"> 	<?php }  else {  ?>
...
<p class="mydata"><b>Conatct No  :</b> <?php echo ucwords($rs['contact']); ?></p>
