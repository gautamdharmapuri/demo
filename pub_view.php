...
<head>
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title>Pubs/Bars View | NRIs</title>
...
<!-- Section-1 START-->	
        ...
        <div class="col-md-8 inner-middle-wrap">
            ...
            <div class="col-md-12" style="text-align:left;color:#000000;"> 
                       ...
                       <br><h4 class="myheadline4"><a href="<?php echo $siteUrlConstant;?>" style="color:#0033FF;">Home</a> >> Pubs/Bars >> <?php 
...
<p class="mydata" align="center" style="text-align:center;">
        ...
        <img src="admin/uploads/pubs/<?php echo $rs['image'];?>" width="80%" style="height:400px !important;"  class="imgframe"> 	<?php }  else {  ?>
