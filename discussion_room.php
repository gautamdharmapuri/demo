...
{ ?>
<a href="<?php echo $siteUrlConstant;?>discussion_room_create"  class="btn btn-default" style="background-color:#0000FF;color:#FFFFFF;float:right;">Create Topic <img src="images/arrow.gif" alt=">"></a>    
  <?php } else { ?> 
<a href="javascript:;"  data-toggle="modal" data-target="#myModal" class="btn btn-default" style="background-color:#990033;color:#FFFFFF;float:right;" >Create Topic &nbsp;<img src="images/arrow.gif" alt=">"></a>   
<?php } ?>                               
</div>    <br>
	...
	{	
		...
		$paginate.= "</div>";		
				...
				{ ?> 
                         ...
                         <tr>
                            <td><a href="<?php echo $siteUrlConstant;?>discussion_room_view?id=<?php echo $rs['id']; ?>" style="color:#000" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='#000'"><?php echo ucwords($rs['title']);  ?></a></td>
                            <td>
                           ...
                           <?php
						$query_blog_cmnt = "select a.*, b.* from nris_talk a, register b where a.member_id = b.id  order by a.id desc limit 1" ;
