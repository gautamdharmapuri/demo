...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState ?> - Auto Create Ad | NRIs</title>
...
<div class="widget-temple">
			<?php $state = $defaultState;?>
				...
				<a href="<?php echo $siteUrlConstant.'auto_inner?code='.$state;?>" class="breadcumb_link">Autos</a>
				>> Create Ad</h4>
</div><br>
...
<br style="clear:both;"><br><br><br><br><br><br>			
		...
		if($final_count >= 3) {
			$url = 'adcheck?redirect=auto_create&State='.$state;
