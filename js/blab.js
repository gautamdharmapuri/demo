effe=2;iev=0; div_toscroll=0; lock_autoscroll=0; txt_b=0; txt_i=0; txt_c=999; tmp_j='';
...
function ad_emo(w){v=document.getElementById('shout_message');v.value=v.value+ ' '+w+' ';v.focus();}
