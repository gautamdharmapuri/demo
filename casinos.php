...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title>Famous Casinos | NRIs</title>
...
<table align="center" >
    ...
    // Get page data
	$query1 = "SELECT DISTINCT  * FROM fam_casinos LEFT OUTER JOIN rating_casinos ON fam_casinos.id = rating_casinos.casino_id GROUP BY(fam_casinos.id) order by rating_casinos.rate desc, fam_casinos.total_views desc LIMIT $start, $limit";
