...
<div class="form-group">
	...
	<div class="col-sm-10">
    <input type="text" class="form-control" id="Titletxt" name="Titletxt" placeholder="Title" style="width:100%;margin-bottom:0px;" tabindex="1" required=''  maxlength="50" onKeyUp="LimtCharacters(this,50,'lblcount');" />  
...
<input type="hidden" name="threadId" id="threadId" value="<?php echo $_GET['cat'] ; ?>">
<input type="hidden" name="memberId" id="memberId" value="<?php echo $_SESSION['Nris_session']['id'];  ?>">
<input type="submit" name="cmdsave" id="cmdsave" class="btn btn-success"  style="float:right" value="Save">
</div>
