...
<div class="widget-temple">
	<?php $state = ($_GET['State'] != '') ? $_GET['State'] : (($_GET['code'] != '') ? $_GET['code'] : $_SESSION['state']);?>
				<h4><a href="state.php?State=<?php echo $state;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo SITE_BASE_URL.'/baby_sitting_inner.php?code='.$state;?>" class="breadcumb_link">Baby Sitting</a> >> Create Ad</h4>
</div><br>
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="text" pattern="[a-zA-Z0-9\s]+" required class="form-control" id="TitleAD" name="TitleAD" placeholder="Title Ad" style="width:100%;margin-bottom:0px;" maxlength="50" tabindex="1" onKeyUp="LimtCharacters(this,50,'lblcount');" required/>               		
