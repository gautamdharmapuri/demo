...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState ?> - My Partner Create Ad | NRIs</title>
...
/*		echo $chk."<bR>"; 				
		...
		if($fileSize1<=200){			
				...
				$img1="uploads/my_partner/".$image1;
		...
		if($adPosttype!='')	
		{
                    ...
                    if ($fileSize2 <= 200) {
                        ...
                        $img2 = "uploads/my_partner/" . $image2;
                ...
                if ($_FILES["my_file3"]["name"] != '') {
                    ...
                    if ($fileSize3 <= 200) {
                        ...
                        $img3 = "uploads/my_partner/" . $image3;
                ...
                if ($_FILES["my_file4"]["name"] != '') {
                    ...
                    if ($fileSize4 <= 200) {
                        ...
                        $img4 = "uploads/my_partner/" . $image4;
                ...
                if ($_FILES["my_file5"]["name"] != '') {
                    ...
                    if ($fileSize5 <= 200) {
                        ...
                        $img5 = "uploads/my_partner/" . $image5;
                ...
                if ($_FILES["my_file6"]["name"] != '') {
                    ...
                    if ($fileSize6 <= 200) {
                        ...
                        $img6 = "uploads/my_partner/" . $image6;
                ...
                if ($_FILES["my_file7"]["name"] != '') {
                    ...
                    if ($fileSize7 <= 200) {
                        ...
                        $img7 = "uploads/my_partner/" . $image7;
                ...
                if ($_FILES["my_file8"]["name"] != '') {
                    ...
                    if ($fileSize8 <= 200) {
                        ...
                        $img8 = "uploads/my_partner/" . $image8;
                ...
                if ($_FILES["my_file9"]["name"] != '') {
                    ...
                    if ($fileSize9 <= 200) {
                        ...
                        $img9 = "uploads/my_partner/" . $image9;
                ...
                if ($_FILES["my_file10"]["name"] != '') {
                    ...
                    if ($fileSize10 <= 200) {
                        ...
                        $img10 = "uploads/my_partner/" . $image10;
                ...
                if ($_FILES["my_file11"]["name"] != '') {
                    ...
                    if ($fileSize11 <= 200) {
                        ...
                        $img11 = "uploads/my_partner/" . $image11;
                ...
                if ($_FILES["my_file12"]["name"] != '') {
                    ...
                    if ($fileSize12 <= 200) {
                        ...
                        $img12 = "uploads/my_partner/" . $image12;
                ...
                if ($_FILES["my_file13"]["name"] != '') {
                    ...
                    if ($fileSize13 <= 200) {
                        ...
                        $img13 = "uploads/my_partner/" . $image13;
                ...
                if ($_FILES["my_file14"]["name"] != '') {
                    ...
                    if ($fileSize14 <= 200) {
                        ...
                        $img14 = "uploads/my_partner/" . $image14;
                ...
                if ($_FILES["my_file15"]["name"] != '') {
                    ...
                    if ($fileSize15 <= 200) {
                        ...
                        $img15 = "uploads/my_partner/" . $image15;
	...
	$EndDate = test_input($_POST["EndDate"]);			
		...
		{			
			...
			if($adPosttype!='')	
			{
			$query=mysql_query("insert into  post_free_mypart (TitleAD,Message,Category,ConatctNAME,ConatctNumber,ConatctEmail,Contact_PID,ShowEmail,States,States_Details,City,image1,image2,image3,image4,image5,image6,image7,image8,image9,image10,image11,image12,image13,image14,image15,AdPostType,URL,EndDate,date,time) VALUES('".$TitleAD."','".$Desrp."','".$Brand."','".$ConatctNAME."','".$ConatctNumber."','".$ConatctEmail."','".$pid."','".$ShowEmail."','".$States."','".$chk."','".$City."','".$image1."','".$image2."','".$image3."','".$image4."','".$image5."','".$image6."','".$image7."','".$image8."','".$image9."','".$image10."','".$image11."','".$image12."','".$image13."','".$image14."','".$image15."','".$adPosttype."','".$URL."','".$EndDate."','".$date."','".$time."')");
			}
			else
			{
		...
		if($_GET['type'] == 'premium') {
			   ...
			   <input type="hidden" name="cancel_return" value="<?php echo $siteUrlConstant; ?>/payment_success?status=fail&type=<?php echo $type; ?>&id=<?php echo ($post_id);?>&state=<?php echo $state;?>&table_name=<?php echo $table_name; ?>">
...
<div class="widget-temple">
	<?php $state = $defaultState;?>
				<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $state;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant.'mypartner_inner?code='.$state;?>" class="breadcumb_link">My Partner</a> >> Create Ads</h4>
</div><br>
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<select name="Brand" id="Brand" required=""  class="form-control"  tabindex="3" >
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="checkbox" id="ShowEmail" name="ShowEmail" value="Yes" tabindex="7" />&nbsp;
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="text" class="form-control" id="URL" name="URL" placeholder="URL" style="width:100%;margin-bottom:0px;" tabindex="11" />               		
	</div>
</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-8">
        <input type="text" class="form-control" name="EndDate" id="EndDate" tabindex="12" required>
	</div>
</div>
</div>
...
<br style="clear:both;"><br><br><br><br><br><br>			
    ...
    <?php
		...
		if($final_count >= 3) {
			$url = 'adcheck?redirect=mypartner_create&State='.$state;
