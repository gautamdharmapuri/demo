...
<p class="mydata" align="center" style="text-align:center;">
        ...
        <img alt="<?php echo ucwords($rs['name']); ?>" src="admin/uploads/sports/<?php echo $rs['image'];?>" width="80%" style="height:400px !important;"  class="imgframe"> 	<?php }  else {  ?>
...
{
		 $query_rate = "update rating_sports set sport_id = '".$pro_id."', rate='".$star."', login_id = '".$myid."', login_name = '".$new_name."', date = '".$date."' where login_id='".$myid."' and sport_id ='".$pro_id."'";		 
