...
<table align="center" >
	...
	{	
		...
		$paginate.= "</div>";		
				...
				{ ?> 
                        <tr>
                            ...
                            <img alt="<?php echo ucwords($rs['rest_name']);?>" src="admin/uploads/restaurants/<?php echo $rs['image'];?>" style="height:50px;width:50px;border-radius: 50%;"></a></td>
        ...
        echo ucwords($rcity['city']);  ?></a>
                        ...
                        <?php } } else { ?>
                        <tr>
                            <td colspan="5">No Records Found - <?php echo $_SESSION['type'];?></td>
                        </tr>
                        <?php } ?>
