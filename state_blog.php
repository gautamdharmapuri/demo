...
<div class="loader"><div class="loader_html"></div></div>
    ...
    <div class="container">
    <?php /*?><div class="row row-centered">
...
<?php
	...
	$query = "select a.*, b.category_name from blog a, blog_categories b where a.category_id  = b.id and  status = 'Publish' order by a.id desc" ;
...
//	$total_pages = $total_pages[num];
    ...
    // Get page data
	$query1 = "select a.*, b.category_name from blog a, blog_categories b where a.category_id  = b.id and status = 'Publish'  order by a.id  desc LIMIT $start, $limit";
