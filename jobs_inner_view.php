...
<div class="widget-temple">
  ...
  <?php
		...
		{ ?>
<a href="job_create.php?code=<?php echo $_SESSION['state'] ?>&type=premium"  class="btn btn-default" style="background-color:#0000FF;color:#FFFFFF;float:right;">Create Premium Post <img src="images/arrow.gif"></a>    
                                     ...
                                     <thead>
                                       ...
                                       <thead>
                                        ...
                                        <?php /*?><tr>
                             			   ...
                             			   <img src="uploads/jobs/<?php echo $rs['image1'];?>" width="300" height="auto"> 	<?php }  else {  ?>
