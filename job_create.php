...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    <head><base href="/">
        ...
        <!-- Basic Page Needs -->
        <meta charset="utf-8">
        <title><?php echo $defaultState ?> - Jobs Create Ad | NRIs</title>
        ...
        <script type="text/javascript">
            function showUser(str)
            {
                ...
                xmlhttp.open("GET", "job_select.php?q=" + nm, true);
                xmlhttp.send();
...
//		echo $States."<br>";
            ...
            if ($Error == '') {
                if ($adPosttype != '') {
                    $query = mysql_query("insert into post_free_job (TitleAD,Message,Category,Job_Role,States,States_Details,City,image1,image2,image3,image4,image5,image6,image7,image8,image9,image10,image11,image12,image13,image14,image15,AdPostType,Emp_type,Job_Ref_Id,ConatctNAME,ConatctNumber,ConatctEmail,Contact_PID,URL,EndDate,date,time) VALUES('" . $TitleAD . "','" . $Desrp . "','" . $Brand . "','" . $SubBrand . "','" . $States . "','" . $chk . "','" . $City . "','" . $image1 . "','" . $image2 . "','" . $image3 . "','" . $image4 . "','" . $image5 . "','" . $image6 . "','" . $image7 . "','" . $image8 . "','" . $image9 . "','" . $image10 . "','" . $image11 . "','" . $image12 . "','" . $image13 . "','" . $image14 . "','" . $image15 . "','" . $adPosttype . "','" . $EmpType . "','" . $RefId . "','" . $ConatctNAME . "','" . $ConatctNumber . "','" . $ConatctEmail . "','" . $pid . "','" . $URL . "','" . $EndDate . "','" . $date . "','" . $time . "')");
                } else {
...
<?php $state = $defaultState; ?>
                            <h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $state; ?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant . 'jobs_inner?code=' . $state; ?>" class="breadcumb_link">Jobs</a> >> Create Ads</h4>
                        </div><br>
        ...
        ?>
                        ...
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label" style="text-align:left;">Job Details</label>
                                <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label"  style="text-align:left;">Select Category</label>
                                    <div class="col-sm-8">
                                        <select name="Brand" id="Brand" required=""  class="form-control"  onChange="showUser();" tabindex="3" >
                                            <option value="">Select Category</option>
                        <?php
                        $query_brand = "select * from  job_category order by name";
                        ...
                        <?php } ?>      	
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label"  style="text-align:left;">Job  State</label>
                                        <div class="col-sm-8">
                            ...
                            <div class="col-md-6">            
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label"  style="text-align:left;">Select Job Role</label>
                                    <div class="col-sm-8">
                                        <div id="myuser">&nbsp;</div>          
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        <!--<input type="text" class="form-control" id="City" name="City" placeholder="City" style="width:100%;margin-bottom:0px;" tabindex="6" required/>-->
                            ...
                            <p style="clear:both;color:#333333;padding:10px;">First Field is Compulsory. Only JPEG,PNG,JPG Type Image<bR>
                            ...
                            <div class="col-md-6">  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="file" class="form-control" id="my_file1" name="my_file1" placeholder="" tabindex="7" />
                                    </div>
                                </div>
                            </div>
...
<?php } ?>
                            ...
                            <div class="col-md-6"> 
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label"  style="text-align:left;font-size:12px;">Employement Type</label>
                                    <div class="col-sm-8">
                                        <select name="EmpType" id="EmpType" required=""  class="form-control"  tabindex="8" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label"  style="text-align:right;">Job Reference Id</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="RefId" name="RefId" placeholder="Job Reference Id" style="width:100%;margin-bottom:0px;" tabindex="22" />               		
                                    </div>
                                </div>
                            </div>
...
while ($fs_state = mysql_fetch_array($qy_state_res)) {
    ...
    ?>
                                                        ...
                                                        <td style="vertical-align:middle;width:auto;">
                                                            <input type="checkbox" name="state_id_multiple[]"  value="<?php echo $fs_state['state_code']; ?>" <?php if ($fs_state['state_code'] == $defaultState) {
        echo "checked";
    } ?> style="padding:3px;">
...
<?php
		...
		if($final_count >= 3) {
			$url = 'adcheck?redirect=job_create&State='.$state;
...
<?php include "config/footer.php"; ?><!--End footer -->
        ...
        <script>
                                    $(function () {
                                        ...
                                        $('#state_auto').keyup(function (e) {
                                            if (e.keyCode == 8)
                                                $('#state_auto, #State, #city_auto, #City').val('');
                                        });
                                        $('#city_auto').keyup(function (e) {
                                            if (e.keyCode == 8)
                                                $('#city_auto, #City').val('');
                                        });
