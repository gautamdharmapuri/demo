...
<head>
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState;  ?> Inter state Carpool | NRIs</title>
...
<div class="widget-temple">
	...
	<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php echo $defaultState;?>" style="color:#0033FF;">Home</a> >> <a href="<?php echo $siteUrlConstant;?>carpool">Inter state Carpool</a></h4>
   <?php
if(isset($_SESSION['Nris_session']))	  
{ ?>
<a href="<?php echo $siteUrlConstant;?>localcarpool_add?code=<?php echo $defaultState; ?>"  class="btn btn-default" style="background-color:#990033;color:#FFFFFF;float:right;">Create Carpool<img src="images/arrow.gif"></a>    
  <?php } else { ?> 
