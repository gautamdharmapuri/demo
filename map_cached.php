...
u/N1cI7/FWAAwuL1LpbcIO8AAAAASUVORK5CYII=" transform="matrix(1 0 0 1 0 1)">
			...
			<g id="text-abb">
				<text id="mymap_1" transform="matrix(1 0 0 1 540 349)" font-family="'Arial'" font-size="16">AL</text>
				<text id="mymap_2" transform="matrix(1 0 0 1 73 391)" font-family="'Arial'" font-size="16">AK</text>
				<text id="mymap_3" transform="matrix(1 0 0 1 166 311)" font-family="'Arial'" font-size="16">AZ</text>
				<text id="mymap_4" transform="matrix(1 0 0 1 451 318)" font-family="'Arial'" font-size="16">AR</text>
				<text id="mymap_5" transform="matrix(1 0 0 1 73 270)" font-family="'Arial'" font-size="16">CA</text>
				<text id="mymap_6" transform="matrix(1 0 0 1 261 238)" font-family="'Arial'" font-size="16">CO</text>
				<text id="mymap_7" transform="matrix(1 0 0 1 736 189)" font-family="'Arial'" font-size="14">CT</text>
				<text id="mymap_8" transform="matrix(1 0 0 1 720 241)" font-family="'Arial'" font-size="14">DE</text>
				<text id="mymap_9" transform="matrix(1 0 0 1 635 427)" font-family="'Arial'" font-size="16">FL</text>
				<text id="mymap_10" transform="matrix(1 0 0 1 590 346)" font-family="'Arial'" font-size="16">GA</text>
				<text id="mymap_11" transform="matrix(1 0 0 1 280 477)" font-family="'Arial'" font-size="14">HI</text>
				<text id="mymap_12" transform="matrix(1 0 0 1 163 139)" font-family="'Arial'" font-size="16">ID</text>
				<text id="mymap_13" transform="matrix(1 0 0 1 498 219)" font-family="'Arial'" font-size="16">IL</text>
				<text id="mymap_14" transform="matrix(1 0 0 1 536 218)" font-family="'Arial'" font-size="16">IN</text>
				<text id="mymap_15" transform="matrix(1 0 0 1 433 185)" font-family="'Arial'" font-size="16">IA</text>
				<text id="mymap_16" transform="matrix(1 0 0 1 366 252)" font-family="'Arial'" font-size="16">KS</text>
				<text id="mymap_17" transform="matrix(1 0 0 1 553 261)" font-family="'Arial'" font-size="16">KY</text>
				<text id="mymap_18" transform="matrix(1 0 0 1 454 390)" font-family="'Arial'" font-size="16">LA</text>
				<text id="mymap_19" transform="matrix(1 0 0 1 733 77)" font-family="'Arial'" font-size="16">ME</text>
				<text id="mymap_20" transform="matrix(1 0 0 1 723 267)" font-family="'Arial'" font-size="14">MD</text>
				<text id="mymap_21" transform="matrix(1 0 0 1 755 119)" font-family="'Arial'" font-size="14">MA</text>
				<text id="mymap_22" transform="matrix(1 0 0 1 548 158)" font-family="'Arial'" font-size="16">MI</text>
				<text id="mymap_23" transform="matrix(1 0 0 1 413 121)" font-family="'Arial'" font-size="16">MN</text>
				<text id="mymap_24" transform="matrix(1 0 0 1 492 354)" font-family="'Arial'" font-size="16">MS</text>
				<text id="mymap_25" transform="matrix(1 0 0 1 444 252)" font-family="'Arial'" font-size="16">MO</text>
				<text id="mymap_26" transform="matrix(1 0 0 1 229 90)" font-family="'Arial'" font-size="16">MT</text>
				<text id="mymap_27" transform="matrix(1 0 0 1 348 196)" font-family="'Arial'" font-size="16">NE</text>
				<text id="mymap_28" transform="matrix(1 0 0 1 110 208)" font-family="'Arial'" font-size="16">NV</text>
				<text id="mymap_29" transform="matrix(1 0 0 1 693 69)" font-family="'Arial'" font-size="14">NH</text>
				<text id="mymap_30" transform="matrix(1 0 0 1 725 215)" font-family="'Arial'" font-size="14">NJ</text>
				<text id="mymap_31" transform="matrix(1 0 0 1 246 321)" font-family="'Arial'" font-size="16">NM</text>
				<text id="mymap_32" transform="matrix(1 0 0 1 668 140)" font-family="'Arial'" font-size="16">NY</text>
				<text id="mymap_33" transform="matrix(1 0 0 1 643 281)" font-family="'Arial'" font-size="16">NC</text>
				<text id="mymap_34" transform="matrix(1 0 0 1 344 89)" font-family="'Arial'" font-size="16">ND</text>
				<text id="mymap_35" transform="matrix(1 0 0 1 574 206)" font-family="'Arial'" font-size="16">OH</text>
				<text id="mymap_36" transform="matrix(1 0 0 1 379 307)" font-family="'Arial'" font-size="16">OK</text>
				<text id="mymap_37" transform="matrix(1 0 0 1 82 117)" font-family="'Arial'" font-size="16">OR</text>
				<text id="mymap_38" transform="matrix(1 0 0 1 642 182)" font-family="'Arial'" font-size="16">PA</text>
				<text id="mymap_39" transform="matrix(1 0 0 1 755 163)" font-family="'Arial'" font-size="14">RI</text>
				<text id="mymap_40" transform="matrix(1 0 0 1 626 315)" font-family="'Arial'" font-size="16">SC</text>
				<text id="mymap_41" transform="matrix(1 0 0 1 343 141)" font-family="'Arial'" font-size="16">SD</text>
				<text id="mymap_42" transform="matrix(1 0 0 1 536 292)" font-family="'Arial'" font-size="16">TN</text>
				<text id="mymap_43" transform="matrix(1 0 0 1 352 383)" font-family="'Arial'" font-size="16">TX</text>
				<text id="mymap_44" transform="matrix(1 0 0 1 182 225)" font-family="'Arial'" font-size="16">UT</text>
				<text id="mymap_45" transform="matrix(1 0 0 1 664 82)" font-family="'Arial'" font-size="14">VT</text>
				<text id="mymap_46" transform="matrix(1 0 0 1 644 244)" font-family="'Arial'" font-size="16">VA</text>
				<text id="mymap_47" transform="matrix(1 0 0 1 95 60)" font-family="'Arial'" font-size="16">WA</text>
				<text id="mymap_48" transform="matrix(1 0 0 1 606 235)" font-family="'Arial'" font-size="16">WV</text>
				<text id="mymap_49" transform="matrix(1 0 0 1 479 142)" font-family="'Arial'" font-size="16">WI</text>
				<text id="mymap_50" transform="matrix(1 0 0 1 242 162)" font-family="'Arial'" font-size="16">WY</text>
			</g>
