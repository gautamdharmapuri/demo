...
<!-- Section-1 START-->	
        ...
        <div class="col-md-8 inner-middle-wrap">
			...
			<div class="widget-temple">
				<h4><a href="<?php echo $siteUrlConstant;?>" style="color:#0033FF;">Home</a> >> Best Visiting Spots >> Pubs/Bars</h4>
			</div><br>
...
<table align="center" >
	...
	$query = "SELECT DISTINCT  * FROM fam_pubs LEFT OUTER JOIN rating_pubs ON fam_pubs.id = rating_pubs.pub_id GROUP BY(fam_pubs.id) order by fam_pubs.total_views desc, rating_pubs.rate desc limit 25";
    ...
    // Get page data
	$query1 = "SELECT DISTINCT  * FROM fam_pubs LEFT OUTER JOIN rating_pubs ON fam_pubs.id = rating_pubs.pub_id GROUP BY(fam_pubs.id) order by fam_pubs.total_views desc, rating_pubs.rate desc LIMIT 25";
	...
	{	
		...
		$paginate.= "</div>";		
				...
				{ ?> 
                            <tr>
                            <td style="padding:5px;"><img src="admin/uploads/pubs/<?php echo $rs['image'];?>" style="height:50px;width:50px;border-radius: 50%;" alt="<?php echo ucwords($rs['name']);?>"></td>
                            ...
                            <td>Views : <?php echo $rs['total_views'];?><br>
                            	Comments : 
                                <?php
								$resultcmt=mysql_query("SELECT count(*) as total from comment_pubs where pub_id ='".$rs[0]."'");
