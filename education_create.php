...
if(isset($_POST['Submit']))
{
	...
	$msg = '';
		...
		if($adPosttype!='')	
		{
					...
					$img10="uploads/education/".$image10;
					...
					$img11="uploads/education/".$image11;
					...
					$img12="uploads/education/".$image12;
					...
					$img13="uploads/education/".$image13;
					...
					$img14="uploads/education/".$image14;
					...
					$img15="uploads/education/".$image15;
...
//		echo $States."<br>";
	...
	//	echo $Error;
		...
		if ($Error=='')
		{
			...
			if($adPosttype!='')	
			{
			$query=mysql_query("insert into post_free_education (TitleAD,Message,AdsCat,ConatctNAME,ConatctNumber,ConatctEmail,Contact_PID,ShowEmail,States,States_Details,City,image,image2,image3,image4,image5,image6,image7,image8,image9,image10,image11,image12,image13,image14,image15,AdPostType,URL,EndDate,date,time) VALUES('".$TitleAD."','".$Desrp."','".$AdsCat."','".$ConatctNAME."','".$ConatctNumber."','".$ConatctEmail."','".$pid."','".$ShowEmail."','".$States."','".$chk."','".$City."','".$image1."','".$image2."','".$image3."','".$image4."','".$image5."','".$image6."','".$image7."','".$image8."','".$image9."','".$image10."','".$image11."','".$image12."','".$image13."','".$image14."','".$image15."','".$adPosttype."','".$URL."','".$EndDate."','".$date."','".$time."')");
			}
			else
			{
		...
		if($_GET['type'] == 'premium') {
				...
				$type = 'education';
				$table_name = 'post_free_education';
				?>
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="text" pattern="[a-zA-Z0-9\s]+" required class="form-control" id="TitleAD" name="TitleAD" placeholder="Title Ad" style="width:100%;margin-bottom:0px;" maxlength="50" tabindex="1" onKeyUp="LimtCharacters(this,50,'lblcount');" />               		
...
<div class="form-group">
	...
	<div class="col-sm-8">
    	<input type="checkbox" id="ShowEmail" value="Yes" name="ShowEmail" tabindex="7" />&nbsp;
...
<div class="col-md-12">
<div class="form-group">
	<label for="inputEmail3" class="col-sm-2 control-label"  style="text-align:right;">URL</label>
	<div class="col-sm-10">
...
<div class="col-md-12">
<div class="form-group">
	<label for="inputEmail3" class="col-sm-2 control-label"  style="text-align:right;">Ad Expiry Date</label>
	<div class="col-sm-10">
