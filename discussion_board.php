...
<div class="widget-temple">
	<h4><a href="state.php" style="color:#0033FF;">Home</a> >> Forum</h4>
</div>    <br>
					...
					while($rs = mysql_fetch_array($result)) { ?>
                        ...
                        <tr>
                            <td style="padding-top:10px;padding-bottom:10px;"><img src="admin/uploads/forum/<?php echo $fs['image']; ?>" style="width:70px;height:auto;">&nbsp;
								<a href="threads.php?id=<?php echo md5($fs['sub_id']); ?>" style="color:#0000FF" onMouseOver="this.style.color='red'" onMouseOut="this.style.color='#0000FF'"><?php echo ucwords($fs['sub_cat_name']) ; ?></a>
                            </td>
