...
//			echo $cat;
	...
	//	$query = "select a.*, b.name, c.role from post_free_job a, job_category b, job_role c where a.Category = b.id and a.Job_Role=c.id  and  a.States  IN ('ALL')";			
			...
			$result = mysql_query($query1);
				...
				{ ?> 
                    <tr>
						<td><a href="auto_inner_view.php?ViewId=<?php echo md5($rs['id']);?>"  onMouseMove="this.style.color='red'" onMouseOut="this.style.color='black'"><?php echo ucwords($rs['TitleAD']);?></a></td>
                ...
                <td><a href="auto_inner_view.php?ViewId=<?php echo md5($rs['id']);?>"  onMouseMove="this.style.color='red'" onMouseOut="this.style.color='black'"><?php echo ucwords($rs['City']);?></a></td>
