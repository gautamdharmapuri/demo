...
<head><base href="/">
	...
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title><?php echo $defaultState;  ?> Baby Sitting Ad View | NRIs</title>
...
<!-- Section-1 START-->	
	...
	<h4><a href="<?php echo $siteUrlConstant;?>state?State=<?php $defaultState;?>" style="color:#0033FF;">Home</a> >> Baby Sitting</h4>
	<?php
				...
				<div class="col-md-3" >
					<?php
						...
						if($rs['image'.$tempVar] != '') { ?>
							<div class="col-sm-12">
								<a href="javascript:;">
									<img class="myImageClass" src="<?php echo 'uploads/baby_sitting/'.$rs['image'.$tempVar];?>" style="width:100%;height:140px;" alt="<?php echo $rs['image'.$tempVar];?>">
								</a>
							</div>
					<?php } ?>
				</div>
