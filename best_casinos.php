...
<!-- Section-1 START-->	
        ...
        <div class="col-md-8 inner-middle-wrap">
            ...
            <div class="widget-temple">
				<h4><a href="<?php echo $siteUrlConstant;?>" style="color:#0033FF;">Home</a> >> Best Visiting Spots >> Casinos</h4>
			</div><br>
...
<table align="center" >
	...
	$query = "SELECT DISTINCT  * FROM fam_casinos LEFT OUTER JOIN rating_casinos ON fam_casinos.id = rating_casinos.casino_id GROUP BY(fam_casinos.id) order by fam_casinos.total_views desc, rating_casinos.rate desc limit 25";
    ...
    // Get page data
	$query1 = "SELECT DISTINCT  * FROM fam_casinos LEFT OUTER JOIN rating_casinos ON fam_casinos.id = rating_casinos.casino_id GROUP BY(fam_casinos.id) order by fam_casinos.total_views desc, rating_casinos.rate desc LIMIT 25";
	...
	{	
		...
		$paginate.= "</div>";		
				...
				{ ?> 
                            <tr>
                            <td style="padding:5px;"><img src="admin/uploads/casinos/<?php echo $rs['image'];?>" style="height:50px;width:50px;border-radius: 50%;" alt="<?php echo ucwords($rs['name']);?>"></td>
                            ...
                            <td>Views :<?php echo $rs['total_views'];?><br>
                                Comments : 
                                <?php
								$resultcmt=mysql_query("SELECT count(*) as total from comment_casinos where casino_id ='".$rs[0]."'");
